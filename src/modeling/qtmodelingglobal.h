...
#ifndef QT_STATIC
#    if defined(QT_BUILD_MODELING_LIB)
#        define Q_MODELING_EXPORT Q_DECL_EXPORT
#    else
#        define Q_MODELING_EXPORT Q_DECL_IMPORT
#    endif
#else
#    define Q_MODELING_EXPORT
#endif
