...
**
****************************************************************************/
#ifndef QTUML_QINVOCATIONACTION_H
#define QTUML_QINVOCATIONACTION_H
...
public:
    Q_INVOKABLE explicit QInvocationAction(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
