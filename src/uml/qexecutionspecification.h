...
public:
    Q_INVOKABLE explicit QExecutionSpecification(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QExecutionSpecification(QExecutionSpecificationPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
