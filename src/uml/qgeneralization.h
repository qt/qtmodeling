...
public:
    Q_INVOKABLE explicit QGeneralization(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QGeneralization(QGeneralizationPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
