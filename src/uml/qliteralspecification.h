...
public:
    Q_INVOKABLE explicit QLiteralSpecification(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QLiteralSpecification();

protected:
    explicit QLiteralSpecification(QLiteralSpecificationPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
