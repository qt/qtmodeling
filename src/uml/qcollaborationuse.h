...
public:
    Q_INVOKABLE explicit QCollaborationUse(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QCollaborationUse(QCollaborationUsePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
