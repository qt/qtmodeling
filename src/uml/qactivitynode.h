...
public:
    Q_INVOKABLE explicit QActivityNode(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QActivityNode(QActivityNodePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
