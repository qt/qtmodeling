...
class Q_UML_EXPORT QDeploymentSpecificationPrivate : public QArtifactPrivate
{
    Q_DECLARE_PUBLIC(QDeploymentSpecification)
...
#endif // QTUML_QDEPLOYMENTSPECIFICATION_P_H
