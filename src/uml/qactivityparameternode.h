...
**
****************************************************************************/
#ifndef QTUML_QACTIVITYPARAMETERNODE_H
#define QTUML_QACTIVITYPARAMETERNODE_H
...
class Q_UML_EXPORT QActivityParameterNode : public QObjectNode
{
    Q_OBJECT
...
Q_DECLARE_METATYPE(QSet<QT_PREPEND_NAMESPACE_QTUML(QActivityParameterNode) *> *)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QActivityParameterNode) *> *)
