...
public:
    Q_INVOKABLE explicit QCreateObjectAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QCreateObjectAction(QCreateObjectActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
