...
public:
    Q_INVOKABLE explicit QReduceAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QReduceAction(QReduceActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
