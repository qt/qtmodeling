...
{
    Q_DECLARE_PUBLIC(QUmlActivityNode)

public:
    explicit QUmlActivityNodePrivate();
    virtual ~QUmlActivityNodePrivate();

    QSet<QUmlActivityNode *> redefinedNodes;
    QSet<QUmlActivityEdge *> incomings;
    ...
    QSet<QUmlActivityEdge *> outgoings;
