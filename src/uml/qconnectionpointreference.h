...
public:
    Q_INVOKABLE explicit QConnectionPointReference(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QConnectionPointReference(QConnectionPointReferencePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
