...
class Q_UML_EXPORT QConnectionPointReference : public QObject, public QVertex
{
    ...
    Q_PROPERTY(QList<QPseudostate *> * entry READ entry)
    Q_PROPERTY(QList<QPseudostate *> * exit READ exit)
...
public:
    ...
    QList<QPseudostate *> *entry();
    QList<QPseudostate *> *exit();
    QState *state() const;
...
Q_DECLARE_METATYPE(QList<QtUml::QConnectionPointReference *>)
Q_DECLARE_METATYPE(QList<QtUml::QConnectionPointReference *> *)
