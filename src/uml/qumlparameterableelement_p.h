...
class Q_UML_EXPORT QUmlParameterableElementPrivate : public QUmlElementPrivate
{
    Q_DECLARE_PUBLIC(QUmlParameterableElement)

public:
    explicit QUmlParameterableElementPrivate();
    virtual ~QUmlParameterableElementPrivate();
