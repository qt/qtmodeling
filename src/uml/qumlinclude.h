...
**
****************************************************************************/
#ifndef QUMLINCLUDE_H
#define QUMLINCLUDE_H
...
class Q_UML_EXPORT QUmlInclude : public QWrappedObject
{
    ...
    Q_PROPERTY(QUmlUseCase * includingCase READ includingCase WRITE setIncludingCase)
    Q_PROPERTY(QUmlUseCase * addition READ addition WRITE setAddition)

    Q_DISABLE_COPY(QUmlInclude)
    Q_DECLARE_PRIVATE(QUmlInclude)

public:
    Q_INVOKABLE explicit QUmlInclude(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
    virtual ~QUmlInclude();
...
protected:
    explicit QUmlInclude(QUmlIncludePrivate &dd, QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
