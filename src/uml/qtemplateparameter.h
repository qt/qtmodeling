...
public:
    Q_INVOKABLE explicit QTemplateParameter(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QTemplateParameter(QTemplateParameterPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
