...
{
    Q_DECLARE_PUBLIC(QUmlAddStructuralFeatureValueAction)

public:
    explicit QUmlAddStructuralFeatureValueActionPrivate();
    virtual ~QUmlAddStructuralFeatureValueActionPrivate();
