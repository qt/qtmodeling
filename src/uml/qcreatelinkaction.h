...
class Q_UML_EXPORT QCreateLinkAction : public QObject, public QWriteLinkAction
{
    Q_OBJECT
    ...
    Q_PROPERTY(QList<QLinkEndCreationData *> * endData READ endData)
...
public:
    ...
    QList<QLinkEndCreationData *> *endData();
...
Q_DECLARE_METATYPE(QList<QtUml::QCreateLinkAction *>)
Q_DECLARE_METATYPE(QList<QtUml::QCreateLinkAction *> *)
