...
class QOperationTemplateParameterPrivate : public QTemplateParameterPrivate
{
public:
    explicit QOperationTemplateParameterPrivate(QOperationTemplateParameter *q_umlptr = 0);
...
#endif // QTUML_QOPERATIONTEMPLATEPARAMETER_P_H
