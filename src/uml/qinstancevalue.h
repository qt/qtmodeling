...
public:
    Q_INVOKABLE explicit QInstanceValue(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QInstanceValue(QInstanceValuePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
