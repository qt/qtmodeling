...
class Q_UML_EXPORT QReadLinkObjectEndAction : public QObject, public QAction
{
    Q_OBJECT
    ...
    QTUML_DECLARE_PRIVATE(QReadLinkObjectEndAction)
...
protected:
    explicit QReadLinkObjectEndAction(bool createPimpl, QObject *parent = 0);
};

QT_END_NAMESPACE_QTUML

Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QReadLinkObjectEndAction) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QReadLinkObjectEndAction) *> *)
