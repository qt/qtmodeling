...
class Q_UML_EXPORT QDestroyLinkAction : public QObject, public QWriteLinkAction
{
    Q_OBJECT
    ...
    QTUML_DECLARE_PRIVATE(QDestroyLinkAction)
...
protected:
    explicit QDestroyLinkAction(bool createPimpl, QObject *parent = 0);
};

QT_END_NAMESPACE_QTUML

Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QDestroyLinkAction) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QDestroyLinkAction) *> *)
