...
public:
    Q_INVOKABLE explicit QDestroyLinkAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QDestroyLinkAction(QDestroyLinkActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
