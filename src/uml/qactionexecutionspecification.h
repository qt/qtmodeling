...
class Q_UML_EXPORT QActionExecutionSpecification : public QExecutionSpecification
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QActionExecutionSpecification(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
