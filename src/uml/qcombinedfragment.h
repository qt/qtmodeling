...
public:
    Q_INVOKABLE explicit QCombinedFragment(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QCombinedFragment(QCombinedFragmentPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
