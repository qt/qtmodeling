...
class Q_UML_EXPORT QCombinedFragment : public QObject, public QInteractionFragment
{
    ...
    Q_PROPERTY(QList<QGate *> * cfragmentGate READ cfragmentGate)
    Q_PROPERTY(QList<QInteractionOperand *> * operand READ operand)
...
public:
    ...
    QList<QGate *> *cfragmentGate();
    QList<QInteractionOperand *> *operand();
