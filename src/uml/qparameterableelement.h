...
public:
    Q_INVOKABLE explicit QParameterableElement(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QParameterableElement(QParameterableElementPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
