...
**
****************************************************************************/
#ifndef QTUML_QMERGENODE_H
#define QTUML_QMERGENODE_H
...
class Q_UML_EXPORT QMergeNode : public QObject, public QControlNode
{
    Q_OBJECT
    ...
    QTUML_DECLARE_PRIVATE(QMergeNode)
...
protected:
    explicit QMergeNode(bool createPimpl, QObject *parent = 0);
};

QT_END_NAMESPACE_QTUML

Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QMergeNode) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QMergeNode) *> *)
