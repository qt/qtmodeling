...
class Q_UML_EXPORT QTemplateParameterSubstitutionPrivate : public QElementPrivate
{
    Q_DECLARE_PUBLIC(QTemplateParameterSubstitution)
...
#endif // QTUML_QTEMPLATEPARAMETERSUBSTITUTION_P_H
