...
class Q_UML_EXPORT QReclassifyObjectAction : public QObject, public QAction
{
    Q_OBJECT
    ...
    Q_PROPERTY(QList<QClassifier *> * newClassifiers READ newClassifiers)
    Q_PROPERTY(QInputPin * object READ object WRITE setObject)
    Q_PROPERTY(QList<QClassifier *> * oldClassifiers READ oldClassifiers)
...
public:
    ...
    QList<QClassifier *> *newClassifiers();
    QInputPin *object() const;
    void setObject(QInputPin *object);
    QList<QClassifier *> *oldClassifiers();
