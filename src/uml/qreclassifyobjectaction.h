...
class Q_UML_EXPORT QReclassifyObjectAction : public QObject, public QAction
{
    ...
    Q_PROPERTY(QList<QClassifier *> * newClassifier READ newClassifier)
    Q_PROPERTY(QInputPin * object READ object WRITE setObject)
    Q_PROPERTY(QList<QClassifier *> * oldClassifier READ oldClassifier)
...
public:
    ...
    QList<QClassifier *> *newClassifier();
    QInputPin *object() const;
    void setObject(QInputPin *object);
    QList<QClassifier *> *oldClassifier();
