...
{
    QModelingObject::propertyDataHash[QStringLiteral("importedPackage")][QtModeling::AggregationRole] = QStringLiteral("none");    QModelingObject::propertyDataHash[QStringLiteral("importedPackage")][QtModeling::IsDerivedUnionRole] = false;
