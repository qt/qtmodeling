...
**
****************************************************************************/
#ifndef QTUML_QPROTOCOLSTATEMACHINE_H
#define QTUML_QPROTOCOLSTATEMACHINE_H
...
public:
    Q_INVOKABLE explicit QProtocolStateMachine(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
