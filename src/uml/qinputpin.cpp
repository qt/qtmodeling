...
QInputPin::QInputPin(QWrappedObject *wrapper, QWrappedObject *parent) :
    QPin(*new QInputPinPrivate, wrapper, parent)
{
    setPropertyData();
}

QInputPin::QInputPin(QInputPinPrivate &dd, QWrappedObject *wrapper, QWrappedObject *parent) :
