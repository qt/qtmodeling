...
class Q_UML_EXPORT QBroadcastSignalActionPrivate : public QInvocationActionPrivate
{
    Q_DECLARE_PUBLIC(QBroadcastSignalAction)
...
#endif // QTUML_QBROADCASTSIGNALACTION_P_H
