...
{
    Q_DECLARE_PUBLIC(QUmlParameterSet)

public:
    explicit QUmlParameterSetPrivate();
    virtual ~QUmlParameterSetPrivate();

    QSet<QUmlParameter *> parameters;
    QSet<QUmlConstraint *> conditions;
};
