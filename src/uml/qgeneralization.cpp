...
void QGeneralization::setPropertyData()
{
    ...
    QWrappedObject::propertyDataHash[QString::fromLatin1("QGeneralization")][QString::fromLatin1("generalizationSets")][QtWrappedObjects::QtWrappedObjects::IsCompositeRole] = false;
