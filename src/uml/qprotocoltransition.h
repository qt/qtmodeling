...
public:
    Q_INVOKABLE explicit QProtocolTransition(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QProtocolTransition(QProtocolTransitionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
