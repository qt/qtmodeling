...
class Q_UML_EXPORT QProfileApplicationPrivate : public QDirectedRelationshipPrivate
{
    Q_DECLARE_PUBLIC(QProfileApplication)
...
#endif // QTUML_QPROFILEAPPLICATION_P_H
