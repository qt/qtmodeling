...
**
****************************************************************************/
#ifndef QTUML_QREADLINKACTION_H
#define QTUML_QREADLINKACTION_H

#include <QtUml/QtUmlGlobal>

// Base class includes
#include <QtUml/QLinkAction>
...
class Q_UML_EXPORT QReadLinkAction : public QLinkAction
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QReadLinkAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QReadLinkAction(QReadLinkActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
