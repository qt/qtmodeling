...
class Q_UML_EXPORT QReadLinkAction : public QObject, public QLinkAction
{
    Q_OBJECT
    ...
    // From QLinkAction
    Q_PROPERTY(QList<QLinkEndData *> * endData READ endData)
...
Q_DECLARE_METATYPE(QList<QtUml::QReadLinkAction *>)
Q_DECLARE_METATYPE(QList<QtUml::QReadLinkAction *> *)
