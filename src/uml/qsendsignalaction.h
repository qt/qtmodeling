...
class Q_UML_EXPORT QSendSignalAction : public QObject, public QInvocationAction
{
    Q_OBJECT
    ...
    Q_PROPERTY(QList<QInputPin *> * argument READ argument)
...
Q_DECLARE_METATYPE(QList<QtUml::QSendSignalAction *>)
Q_DECLARE_METATYPE(QList<QtUml::QSendSignalAction *> *)
