...
**
****************************************************************************/
#ifndef QTUML_QSENDSIGNALACTION_H
#define QTUML_QSENDSIGNALACTION_H
...
class Q_UML_EXPORT QSendSignalAction : public QInvocationAction
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QSendSignalAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QSendSignalAction(QSendSignalActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
