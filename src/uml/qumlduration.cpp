...
void QUmlDuration::setClassForProperty()
{
    ...
    _classForProperty[QStringLiteral("expr")] = QStringLiteral("QUmlDuration");
    _classForProperty[QStringLiteral("observations")] = QStringLiteral("QUmlDuration");
}
