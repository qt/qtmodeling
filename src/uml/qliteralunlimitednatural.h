...
public:
    Q_INVOKABLE explicit QLiteralUnlimitedNatural(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QLiteralUnlimitedNatural(QLiteralUnlimitedNaturalPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
