...
class Q_UML_EXPORT QUmlArtifact : public QWrappedObject
{
    ...
    Q_PROPERTY(QSet<QUmlManifestation *> manifestations READ manifestations)
    Q_PROPERTY(QSet<QUmlArtifact *> nestedArtifacts READ nestedArtifacts)

    Q_DISABLE_COPY(QUmlArtifact)
    Q_DECLARE_PRIVATE(QUmlArtifact)

public:
    Q_INVOKABLE explicit QUmlArtifact(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
    ...
    Q_INVOKABLE QSet<QUmlManifestation *> manifestations() const;
    Q_INVOKABLE void addManifestation(QUmlManifestation *manifestation);
    Q_INVOKABLE void removeManifestation(QUmlManifestation *manifestation);
    Q_INVOKABLE QSet<QUmlArtifact *> nestedArtifacts() const;
    Q_INVOKABLE void addNestedArtifact(QUmlArtifact *nestedArtifact);
    Q_INVOKABLE void removeNestedArtifact(QUmlArtifact *nestedArtifact);

    // Overriden methods for subsetted properties
    Q_INVOKABLE void addClientDependency(QWrappedObjectPointer<QUmlManifestation> manifestation);
    Q_INVOKABLE void removeClientDependency(QWrappedObjectPointer<QUmlManifestation> manifestation);

    virtual void setPropertyData();

protected:
    explicit QUmlArtifact(QUmlArtifactPrivate &dd, QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
