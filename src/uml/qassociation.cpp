...
void QAssociation::setPropertyData()
{
    ...
    QWrappedObject::propertyDataHash[QString::fromLatin1("QAssociation")][QString::fromLatin1("ownedEnds")][QtWrappedObjects::QtWrappedObjects::SubsettedPropertiesRole] = QString::fromLatin1("QAssociation::memberEnds QClassifier::features QNamespace::ownedMembers");
