...
public:
    Q_INVOKABLE explicit QExtension(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QExtension();
...
protected:
    explicit QExtension(QExtensionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
