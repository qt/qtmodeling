...
public:
    Q_INVOKABLE explicit QControlFlow(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QControlFlow();

protected:
    explicit QControlFlow(QControlFlowPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
