...
**
****************************************************************************/
#ifndef QTUML_QCONTROLFLOW_H
#define QTUML_QCONTROLFLOW_H
...
protected:
    explicit QControlFlow(QControlFlowPrivate &dd, QObject *parent = 0);
};

QT_END_NAMESPACE_QTUML

Q_DECLARE_METATYPE(QT_PREPEND_NAMESPACE_QTUML(QControlFlow) *)
Q_DECLARE_METATYPE(QSet<QT_PREPEND_NAMESPACE_QTUML(QControlFlow) *> *)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QControlFlow) *> *)
