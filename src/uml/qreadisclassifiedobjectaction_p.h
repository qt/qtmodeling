...
class Q_UML_EXPORT QReadIsClassifiedObjectActionPrivate : public QActionPrivate
{
    Q_DECLARE_PUBLIC(QReadIsClassifiedObjectAction)
...
#endif // QTUML_QREADISCLASSIFIEDOBJECTACTION_P_H
