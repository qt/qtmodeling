...
**
****************************************************************************/
#ifndef QTUML_QREADSTRUCTURALFEATUREACTION_H
#define QTUML_QREADSTRUCTURALFEATUREACTION_H
...
class Q_UML_EXPORT QReadStructuralFeatureAction : public QStructuralFeatureAction
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QReadStructuralFeatureAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QReadStructuralFeatureAction(QReadStructuralFeatureActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
