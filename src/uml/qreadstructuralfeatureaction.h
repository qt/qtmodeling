...
Q_DECLARE_METATYPE(QSet<QT_PREPEND_NAMESPACE_QTUML(QReadStructuralFeatureAction) *> *)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QReadStructuralFeatureAction) *> *)
