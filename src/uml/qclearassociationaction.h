...
public:
    Q_INVOKABLE explicit QClearAssociationAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QClearAssociationAction(QClearAssociationActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
