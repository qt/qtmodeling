...
QClause::QClause(QWrappedObject *wrapper, QWrappedObject *parent) :
    QElement(*new QClausePrivate, wrapper, parent)
{
    setPropertyData();
}

QClause::QClause(QClausePrivate &dd, QWrappedObject *wrapper, QWrappedObject *parent) :
...
void QClause::setPropertyData()
{
    ...
    QWrappedObject::propertyDataHash[QString::fromLatin1("QClause")][QString::fromLatin1("successorClauses")][QtWrappedObjects::QtWrappedObjects::IsDerivedUnionRole] = false;
