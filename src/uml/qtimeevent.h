...
public:
    Q_INVOKABLE explicit QTimeEvent(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QTimeEvent();
...
protected:
    explicit QTimeEvent(QTimeEventPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
