...
void QUmlSubstitution::setClassForProperty()
{
    ...
    _classForProperty[QStringLiteral("contract")] = QStringLiteral("QUmlSubstitution");
    _classForProperty[QStringLiteral("substitutingClassifier")] = QStringLiteral("QUmlSubstitution");
}
