...
{
    QModelingObject::propertyDataHash[QStringLiteral("isLeaf")][QtModeling::AggregationRole] = QStringLiteral("none");    QModelingObject::propertyDataHash[QStringLiteral("isLeaf")][QtModeling::IsDerivedUnionRole] = false;
    ...
    QModelingObject::propertyDataHash[QStringLiteral("redefinedElement")][QtModeling::AggregationRole] = QStringLiteral("none");    QModelingObject::propertyDataHash[QStringLiteral("redefinedElement")][QtModeling::IsDerivedUnionRole] = true;
    ...
    QModelingObject::propertyDataHash[QStringLiteral("redefinitionContext")][QtModeling::AggregationRole] = QStringLiteral("none");    QModelingObject::propertyDataHash[QStringLiteral("redefinitionContext")][QtModeling::IsDerivedUnionRole] = true;
