...
class Q_UML_EXPORT QClearStructuralFeatureAction : public QObject, public QStructuralFeatureAction
{
    Q_OBJECT
...
protected:
    explicit QClearStructuralFeatureAction(bool createPimpl, QObject *parent = 0);
};
