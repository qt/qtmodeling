...
public:
    Q_INVOKABLE explicit QClearStructuralFeatureAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QClearStructuralFeatureAction(QClearStructuralFeatureActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
