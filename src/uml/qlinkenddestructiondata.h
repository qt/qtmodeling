...
**
****************************************************************************/
#ifndef QTUML_QLINKENDDESTRUCTIONDATA_H
#define QTUML_QLINKENDDESTRUCTIONDATA_H
...
public:
    Q_INVOKABLE explicit QLinkEndDestructionData(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
