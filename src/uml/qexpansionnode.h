...
public:
    Q_INVOKABLE explicit QExpansionNode(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QExpansionNode(QExpansionNodePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
