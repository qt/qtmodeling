...
**
****************************************************************************/
#ifndef QTUML_QDEVICE_H
#define QTUML_QDEVICE_H
...
public:
    Q_INVOKABLE explicit QDevice(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QDevice();

protected:
    explicit QDevice(QDevicePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
