...
class Q_UML_EXPORT QReadLinkObjectEndQualifierActionPrivate : public QActionPrivate
{
    Q_DECLARE_PUBLIC(QReadLinkObjectEndQualifierAction)
...
#endif // QTUML_QREADLINKOBJECTENDQUALIFIERACTION_P_H
