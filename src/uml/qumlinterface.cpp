...
void QUmlInterface::setClassForProperty()
{
    ...
    _classForProperty[QStringLiteral("nestedClassifiers")] = QStringLiteral("QUmlInterface");
    _classForProperty[QStringLiteral("ownedAttributes")] = QStringLiteral("QUmlInterface");
    _classForProperty[QStringLiteral("ownedOperations")] = QStringLiteral("QUmlInterface");
