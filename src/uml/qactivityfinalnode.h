...
public:
    Q_INVOKABLE explicit QActivityFinalNode(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QActivityFinalNode();

protected:
    explicit QActivityFinalNode(QActivityFinalNodePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
