...
**
****************************************************************************/
#ifndef QTUML_QACTIVITYFINALNODE_H
#define QTUML_QACTIVITYFINALNODE_H
...
protected:
    explicit QActivityFinalNode(QActivityFinalNodePrivate &dd, QObject *parent = 0);
};

QT_END_NAMESPACE_QTUML

Q_DECLARE_METATYPE(QT_PREPEND_NAMESPACE_QTUML(QActivityFinalNode) *)
Q_DECLARE_METATYPE(QSet<QT_PREPEND_NAMESPACE_QTUML(QActivityFinalNode) *> *)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QActivityFinalNode) *> *)
