...
**
****************************************************************************/
#ifndef QTUML_QFLOWFINALNODE_H
#define QTUML_QFLOWFINALNODE_H
...
class Q_UML_EXPORT QFlowFinalNode : public QObject, public QFinalNode
{
    Q_OBJECT
...
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QFlowFinalNode) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QFlowFinalNode) *> *)
