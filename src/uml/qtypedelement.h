...
**
****************************************************************************/
#ifndef QTUML_QTYPEDELEMENT_H
#define QTUML_QTYPEDELEMENT_H
...
public:
    Q_INVOKABLE explicit QTypedElement(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QTypedElement(QTypedElementPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
