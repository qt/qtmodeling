...
class Q_UML_EXPORT QActivityParameterNodePrivate : public QObjectNodePrivate
{
    Q_DECLARE_PUBLIC(QActivityParameterNode)
...
#endif // QTUML_QACTIVITYPARAMETERNODE_P_H
