...
void QActivityGroup::setPropertyData()
{
    ...
    QWrappedObject::propertyDataHash[QString::fromLatin1("QActivityGroup")][QString::fromLatin1("inActivity")][QtWrappedObjects::QtWrappedObjects::IsDerivedUnionRole] = false;
