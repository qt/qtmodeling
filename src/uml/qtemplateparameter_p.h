...
**
****************************************************************************/
#ifndef QTUML_QTEMPLATEPARAMETER_P_H
#define QTUML_QTEMPLATEPARAMETER_P_H
...
class Q_UML_EXPORT QTemplateParameterPrivate : public QElementPrivate
{
    Q_DECLARE_PUBLIC(QTemplateParameter)
...
#endif // QTUML_QTEMPLATEPARAMETER_P_H
