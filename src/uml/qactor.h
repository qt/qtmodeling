...
class Q_UML_EXPORT QActor : public QObject, public QBehavioredClassifier
{
    Q_OBJECT
...
protected:
    explicit QActor(bool createPimpl, QObject *parent = 0);
};

QT_END_NAMESPACE_QTUML

Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QActor) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QActor) *> *)
