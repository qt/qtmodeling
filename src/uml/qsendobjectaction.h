...
public:
    Q_INVOKABLE explicit QSendObjectAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QSendObjectAction(QSendObjectActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
