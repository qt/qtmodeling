...
public:
    Q_INVOKABLE explicit QProtocolConformance(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QProtocolConformance(QProtocolConformancePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
