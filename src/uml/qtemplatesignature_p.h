...
class QTemplateSignaturePrivate : public virtual QElementPrivate
{
public:
    explicit QTemplateSignaturePrivate(QTemplateSignature *q_umlptr = 0);
...
#endif // QTUML_QTEMPLATESIGNATURE_P_H
