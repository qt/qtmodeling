...
public:
    Q_INVOKABLE explicit QValuePin(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QValuePin();
...
protected:
    explicit QValuePin(QValuePinPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
