...
QAnyReceiveEvent::QAnyReceiveEvent(QWrappedObject *wrapper, QWrappedObject *parent) :
    QMessageEvent(*new QAnyReceiveEventPrivate, wrapper, parent)
{
    setPropertyData();
}

QAnyReceiveEvent::QAnyReceiveEvent(QAnyReceiveEventPrivate &dd, QWrappedObject *wrapper, QWrappedObject *parent) :
