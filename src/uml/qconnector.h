...
public:
    Q_INVOKABLE explicit QConnector(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QConnector();
...
protected:
    explicit QConnector(QConnectorPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
