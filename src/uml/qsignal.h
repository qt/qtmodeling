...
class Q_UML_EXPORT QSignal : public QClassifier
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QSignal(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QSignal();
...
protected:
    explicit QSignal(QSignalPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
