...
class Q_UML_EXPORT QOutputPin : public QPin
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QOutputPin(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QOutputPin();

protected:
    explicit QOutputPin(QOutputPinPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
