...
**
****************************************************************************/
#ifndef QTUML_QFEATURE_H
#define QTUML_QFEATURE_H
...
public:
    Q_INVOKABLE explicit QFeature(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QFeature();
...
protected:
    explicit QFeature(QFeaturePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
