...
public:
    Q_INVOKABLE explicit QConnectorEnd(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QConnectorEnd(QConnectorEndPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
