...
**
****************************************************************************/
#ifndef QTUML_QANYRECEIVEEVENT_H
#define QTUML_QANYRECEIVEEVENT_H
...
protected:
    explicit QAnyReceiveEvent(QAnyReceiveEventPrivate &dd, QObject *parent = 0);
};

QT_END_NAMESPACE_QTUML

Q_DECLARE_METATYPE(QT_PREPEND_NAMESPACE_QTUML(QAnyReceiveEvent) *)
Q_DECLARE_METATYPE(QSet<QT_PREPEND_NAMESPACE_QTUML(QAnyReceiveEvent) *> *)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QAnyReceiveEvent) *> *)
