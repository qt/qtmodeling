...
class Q_UML_EXPORT QBehaviorExecutionSpecificationPrivate : public QExecutionSpecificationPrivate
{
    Q_DECLARE_PUBLIC(QBehaviorExecutionSpecification)
...
#endif // QTUML_QBEHAVIOREXECUTIONSPECIFICATION_P_H
