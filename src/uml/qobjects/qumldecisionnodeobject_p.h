...
class Q_UML_EXPORT QUmlDecisionNodeObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * decisionInput READ decisionInput WRITE setDecisionInput NOTIFY decisionInputChanged)
    Q_PROPERTY(QObject * decisionInputFlow READ decisionInputFlow WRITE setDecisionInputFlow NOTIFY decisionInputFlowChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [DecisionNode]
    void decisionInputChanged(QObject *decisionInput);
    void decisionInputFlowChanged(QObject *decisionInputFlow);
