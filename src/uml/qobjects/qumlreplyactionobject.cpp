...
void QUmlReplyActionObject::setReplyToCall(QObject *replyToCall)
{
    ...
    emit replyToCallChanged(this->replyToCall());
}
...
void QUmlReplyActionObject::addReplyValue(QObject *replyValue)
{
    ...
    emit replyValuesChanged(this->replyValues());
}
...
void QUmlReplyActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReplyAction, replyToCall, PropertyTypeRole, QStringLiteral("QUmlTrigger *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReplyAction, replyValues, PropertyTypeRole, QStringLiteral("QSet<QUmlInputPin *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReplyAction, returnInformation, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
