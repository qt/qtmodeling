...
QUmlReadExtentActionObject::QUmlReadExtentActionObject(QUmlReadExtentAction *modelingElement)
{
...
void QUmlReadExtentActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadExtentAction, classifier, PropertyTypeRole, QStringLiteral("QUmlClassifier *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadExtentAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
