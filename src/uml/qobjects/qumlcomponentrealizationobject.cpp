...
void QUmlComponentRealizationObject::setAbstraction(QObject *abstraction)
{
    ...
    emit abstractionChanged(this->abstraction());
}
...
void QUmlComponentRealizationObject::addRealizingClassifier(QObject *realizingClassifier)
{
    ...
    emit realizingClassifiersChanged(this->realizingClassifiers());
}
...
void QUmlComponentRealizationObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlComponentRealization, abstraction, PropertyTypeRole, QStringLiteral("QUmlComponent *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlComponentRealization, realizingClassifiers, PropertyTypeRole, QStringLiteral("QSet<QUmlClassifier *>"));
