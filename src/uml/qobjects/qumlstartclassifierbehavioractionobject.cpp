...
QUmlStartClassifierBehaviorActionObject::QUmlStartClassifierBehaviorActionObject(QUmlStartClassifierBehaviorAction *modelingElement)
{
...
void QUmlStartClassifierBehaviorActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlStartClassifierBehaviorAction, object, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
