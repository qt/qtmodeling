...
class Q_UML_EXPORT QUmlUnmarshallActionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * unmarshallType READ unmarshallType WRITE setUnmarshallType NOTIFY unmarshallTypeChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [UnmarshallAction]
    void objectChanged(QObject *object);
    void resultsChanged(QSet<QObject *> results);
    void unmarshallTypeChanged(QObject *unmarshallType);
