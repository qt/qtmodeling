...
class Q_UML_EXPORT QUmlTimeObservationObject : public QModelingObject
{
    ...
    Q_PROPERTY(bool firstEvent READ firstEvent WRITE setFirstEvent NOTIFY firstEventChanged RESET unsetFirstEvent)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [TimeObservation]
