...
class Q_UML_EXPORT QUmlSubstitutionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * substitutingClassifier READ substitutingClassifier WRITE setSubstitutingClassifier NOTIFY substitutingClassifierChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Substitution]
    void contractChanged(QObject *contract);
    void substitutingClassifierChanged(QObject *substitutingClassifier);
