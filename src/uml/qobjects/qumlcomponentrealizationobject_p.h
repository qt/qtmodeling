...
class Q_UML_EXPORT QUmlComponentRealizationObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * abstraction READ abstraction WRITE setAbstraction NOTIFY abstractionChanged)
    Q_PROPERTY(QSet<QObject *> realizingClassifiers READ realizingClassifiers NOTIFY realizingClassifiersChanged)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> realizingClassifiers() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ComponentRealization]
    void abstractionChanged(QObject *abstraction);
    void realizingClassifiersChanged(QSet<QObject *> realizingClassifiers);
