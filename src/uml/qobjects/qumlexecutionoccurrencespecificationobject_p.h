...
class Q_UML_EXPORT QUmlExecutionOccurrenceSpecificationObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * execution READ execution WRITE setExecution NOTIFY executionChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ExecutionOccurrenceSpecification]
    void executionChanged(QObject *execution);
