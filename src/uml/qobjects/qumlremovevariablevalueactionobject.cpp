...
void QUmlRemoveVariableValueActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlVariableAction, variable, PropertyTypeRole, QStringLiteral("QUmlVariable *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlWriteVariableAction, value, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlRemoveVariableValueAction, isRemoveDuplicates, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlRemoveVariableValueAction, removeAt, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
