...
class Q_UML_EXPORT QUmlParameterSetObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> conditions READ conditions NOTIFY conditionsChanged)
    Q_PROPERTY(QSet<QObject *> parameters READ parameters NOTIFY parametersChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ParameterSet]
    void conditionsChanged(QSet<QObject *> conditions);
    void parametersChanged(QSet<QObject *> parameters);
