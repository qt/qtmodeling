...
void QUmlConsiderIgnoreFragmentObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCombinedFragment, cfragmentGates, PropertyTypeRole, QStringLiteral("QSet<QUmlGate *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCombinedFragment, interactionOperator, PropertyTypeRole, QStringLiteral("QtUml::InteractionOperatorKind"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCombinedFragment, operands, PropertyTypeRole, QStringLiteral("QList<QUmlInteractionOperand *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlConsiderIgnoreFragment, messages, PropertyTypeRole, QStringLiteral("QSet<QUmlNamedElement *>"));
