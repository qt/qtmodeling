...
class Q_UML_EXPORT QUmlPortObject : public QModelingObject
{
    ...
    // Properties [Port]
    Q_PROPERTY(bool isBehavior READ isBehavior WRITE setBehavior NOTIFY isBehaviorChanged RESET unsetBehavior)
    Q_PROPERTY(bool isConjugated READ isConjugated WRITE setConjugated NOTIFY isConjugatedChanged RESET unsetConjugated)
    Q_PROPERTY(bool isService READ isService WRITE setService NOTIFY isServiceChanged RESET unsetService)
    ...
    Q_PROPERTY(QSet<QObject *> redefinedPorts READ redefinedPorts NOTIFY redefinedPortsChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Port]
    void isBehaviorChanged(bool isBehavior);
    void isConjugatedChanged(bool isConjugated);
    void isServiceChanged(bool isService);
    void protocolChanged(QObject *protocol);
    void providedChanged(QSet<QObject *> provided);
    void redefinedPortsChanged(QSet<QObject *> redefinedPorts);
