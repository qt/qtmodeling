...
class Q_UML_EXPORT QUmlProfileObject : public QModelingObject
{
    ...
    // Properties [Profile]
    Q_PROPERTY(QSet<QObject *> metaclassReferences READ metaclassReferences NOTIFY metaclassReferencesChanged)
    Q_PROPERTY(QSet<QObject *> metamodelReferences READ metamodelReferences NOTIFY metamodelReferencesChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Profile]
    void metaclassReferencesChanged(QSet<QObject *> metaclassReferences);
    void metamodelReferencesChanged(QSet<QObject *> metamodelReferences);
