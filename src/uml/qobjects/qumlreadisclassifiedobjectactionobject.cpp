...
void QUmlReadIsClassifiedObjectActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadIsClassifiedObjectAction, classifier, PropertyTypeRole, QStringLiteral("QUmlClassifier *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadIsClassifiedObjectAction, isDirect, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadIsClassifiedObjectAction, object, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadIsClassifiedObjectAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
