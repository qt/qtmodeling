...
class Q_UML_EXPORT QUmlReadIsClassifiedObjectActionObject : public QModelingObject
{
    ...
    Q_PROPERTY(bool isDirect READ isDirect WRITE setDirect NOTIFY isDirectChanged RESET unsetDirect)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ReadIsClassifiedObjectAction]
    void classifierChanged(QObject *classifier);
    void isDirectChanged(bool isDirect);
