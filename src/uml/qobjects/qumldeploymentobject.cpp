...
void QUmlDeploymentObject::addConfiguration(QObject *configuration)
{
    ...
    emit configurationsChanged(this->configurations());
}
...
void QUmlDeploymentObject::addDeployedArtifact(QObject *deployedArtifact)
{
    ...
    emit deployedArtifactsChanged(this->deployedArtifacts());
}
...
void QUmlDeploymentObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlDeployment, configurations, PropertyTypeRole, QStringLiteral("QSet<QUmlDeploymentSpecification *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlDeployment, deployedArtifacts, PropertyTypeRole, QStringLiteral("QSet<QUmlDeployedArtifact *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlDeployment, location, PropertyTypeRole, QStringLiteral("QUmlDeploymentTarget *"));
