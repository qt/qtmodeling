...
void QUmlValueSpecificationActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlValueSpecificationAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlValueSpecificationAction, value, PropertyTypeRole, QStringLiteral("QUmlValueSpecification *"));
