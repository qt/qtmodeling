...
public:
    Q_INVOKABLE explicit QUmlValueSpecificationActionObject(QUmlValueSpecificationAction *modelingElement);
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ValueSpecificationAction]
