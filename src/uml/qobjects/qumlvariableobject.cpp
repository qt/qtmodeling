...
QString QUmlVariableObject::upper() const
{
...
QString QUmlVariableObject::upperBoundOperation() const
{
    return qmodelingelementproperty_cast<QUmlVariable *>(this)->upperBoundOperation();
}
...
void QUmlVariableObject::setUpper(QString upper)
{
...
void QUmlVariableObject::setActivityScope(QObject *activityScope)
{
    ...
    emit activityScopeChanged(this->activityScope());
}
...
void QUmlVariableObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlVariable, activityScope, PropertyTypeRole, QStringLiteral("QUmlActivity *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlVariable, scope, PropertyTypeRole, QStringLiteral("QUmlStructuredActivityNode *"));
