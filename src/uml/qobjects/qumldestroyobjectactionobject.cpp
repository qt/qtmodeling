...
void QUmlDestroyObjectActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlDestroyObjectAction, isDestroyLinks, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlDestroyObjectAction, isDestroyOwnedObjects, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlDestroyObjectAction, target, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
