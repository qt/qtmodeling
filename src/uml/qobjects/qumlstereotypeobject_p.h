...
class Q_UML_EXPORT QUmlStereotypeObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> icons READ icons NOTIFY iconsChanged)
    Q_PROPERTY(QObject * profile READ profile NOTIFY profileChanged STORED false)
...
public:
    ...
    Q_TODO Q_INVOKABLE QObject *profile() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Stereotype]
    void iconsChanged(QSet<QObject *> icons);
    void profileChanged(QObject *profile);
