...
void QUmlExtensionEndObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExtensionEnd, lower, PropertyTypeRole, QStringLiteral("int"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExtensionEnd, type, PropertyTypeRole, QStringLiteral("QUmlStereotype *"));
