...
void QUmlLinkEndCreationDataObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlLinkEndCreationData, insertAt, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlLinkEndCreationData, isReplaceAll, PropertyTypeRole, QStringLiteral("bool"));
