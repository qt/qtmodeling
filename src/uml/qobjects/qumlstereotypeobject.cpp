...
void QUmlStereotypeObject::setProfile(QObject *profile)
{
    ...
    emit profileChanged(this->profile());
}
...
void QUmlStereotypeObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlStereotype, icons, PropertyTypeRole, QStringLiteral("QSet<QUmlImage *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlStereotype, profile, PropertyTypeRole, QStringLiteral("QUmlProfile *"));
