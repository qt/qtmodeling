...
void QUmlReclassifyObjectActionObject::addNewClassifier(QObject *newClassifier)
{
    ...
    emit newClassifiersChanged(this->newClassifiers());
}
...
void QUmlReclassifyObjectActionObject::addOldClassifier(QObject *oldClassifier)
{
    ...
    emit oldClassifiersChanged(this->oldClassifiers());
}
...
void QUmlReclassifyObjectActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReclassifyObjectAction, isReplaceAll, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReclassifyObjectAction, newClassifiers, PropertyTypeRole, QStringLiteral("QSet<QUmlClassifier *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReclassifyObjectAction, object, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReclassifyObjectAction, oldClassifiers, PropertyTypeRole, QStringLiteral("QSet<QUmlClassifier *>"));
