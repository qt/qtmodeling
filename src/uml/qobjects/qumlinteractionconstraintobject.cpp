...
void QUmlInteractionConstraintObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInteractionConstraint, maxint, PropertyTypeRole, QStringLiteral("QUmlValueSpecification *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInteractionConstraint, minint, PropertyTypeRole, QStringLiteral("QUmlValueSpecification *"));
