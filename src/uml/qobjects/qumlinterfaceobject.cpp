...
void QUmlInterfaceObject::addRedefinedInterface(QObject *redefinedInterface)
{
    ...
    emit redefinedInterfacesChanged(this->redefinedInterfaces());
}
...
void QUmlInterfaceObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterface, nestedClassifiers, PropertyTypeRole, QStringLiteral("QList<QUmlClassifier *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterface, ownedAttributes, PropertyTypeRole, QStringLiteral("QList<QUmlProperty *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterface, ownedOperations, PropertyTypeRole, QStringLiteral("QList<QUmlOperation *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterface, ownedReceptions, PropertyTypeRole, QStringLiteral("QSet<QUmlReception *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterface, protocol, PropertyTypeRole, QStringLiteral("QUmlProtocolStateMachine *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterface, redefinedInterfaces, PropertyTypeRole, QStringLiteral("QSet<QUmlInterface *>"));
