...
void QUmlCreateLinkObjectActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlLinkAction, endData, PropertyTypeRole, QStringLiteral("QSet<QUmlLinkEndData *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlLinkAction, inputValues, PropertyTypeRole, QStringLiteral("QSet<QUmlInputPin *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCreateLinkAction, endData, PropertyTypeRole, QStringLiteral("QSet<QUmlLinkEndCreationData *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCreateLinkObjectAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
