...
void QUmlParameterSetObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameterSet, conditions, PropertyTypeRole, QStringLiteral("QSet<QUmlConstraint *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameterSet, parameters, PropertyTypeRole, QStringLiteral("QSet<QUmlParameter *>"));
