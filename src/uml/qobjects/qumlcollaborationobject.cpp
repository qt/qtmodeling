...
void QUmlCollaborationObject::addCollaborationRole(QObject *collaborationRole)
{
    ...
    emit collaborationRolesChanged(this->collaborationRoles());
}
...
void QUmlCollaborationObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCollaboration, collaborationRoles, PropertyTypeRole, QStringLiteral("QSet<QUmlConnectableElement *>"));
