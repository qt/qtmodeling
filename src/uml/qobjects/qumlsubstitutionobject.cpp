...
void QUmlSubstitutionObject::setSubstitutingClassifier(QObject *substitutingClassifier)
{
    ...
    emit substitutingClassifierChanged(this->substitutingClassifier());
}
...
void QUmlSubstitutionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlSubstitution, contract, PropertyTypeRole, QStringLiteral("QUmlClassifier *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlSubstitution, substitutingClassifier, PropertyTypeRole, QStringLiteral("QUmlClassifier *"));
