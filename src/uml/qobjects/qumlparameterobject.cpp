...
void QUmlParameterObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameter, default_, PropertyTypeRole, QStringLiteral("QString"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameter, defaultValue, PropertyTypeRole, QStringLiteral("QUmlValueSpecification *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameter, direction, PropertyTypeRole, QStringLiteral("QtUml::ParameterDirectionKind"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameter, effect, PropertyTypeRole, QStringLiteral("QtUml::ParameterEffectKind"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameter, isException, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameter, isStream, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameter, operation, PropertyTypeRole, QStringLiteral("QUmlOperation *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlParameter, parameterSets, PropertyTypeRole, QStringLiteral("QSet<QUmlParameterSet *>"));
