...
QUmlRaiseExceptionActionObject::QUmlRaiseExceptionActionObject(QUmlRaiseExceptionAction *modelingElement)
{
...
void QUmlRaiseExceptionActionObject::setException(QObject *exception)
{
    ...
    emit exceptionChanged(this->exception());
}
...
void QUmlRaiseExceptionActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlRaiseExceptionAction, exception, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
