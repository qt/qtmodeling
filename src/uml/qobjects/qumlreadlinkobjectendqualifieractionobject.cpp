...
void QUmlReadLinkObjectEndQualifierActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadLinkObjectEndQualifierAction, object, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadLinkObjectEndQualifierAction, qualifier, PropertyTypeRole, QStringLiteral("QUmlProperty *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadLinkObjectEndQualifierAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
