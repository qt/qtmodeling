...
class Q_UML_EXPORT QUmlActivityObject : public QModelingObject
{
    ...
    Q_PROPERTY(bool isReentrant READ isReentrant WRITE setReentrant NOTIFY isReentrantChanged RESET unsetReentrant)
    ...
    Q_PROPERTY(QSet<QObject *> redefinedBehaviors READ redefinedBehaviors NOTIFY redefinedBehaviorsChanged)
    ...
    Q_PROPERTY(QSet<QObject *> groups READ groups NOTIFY groupsChanged)
    Q_PROPERTY(bool isReadOnly READ isReadOnly WRITE setReadOnly NOTIFY isReadOnlyChanged RESET unsetReadOnly)
    Q_PROPERTY(bool isSingleExecution READ isSingleExecution WRITE setSingleExecution NOTIFY isSingleExecutionChanged RESET unsetSingleExecution)
    Q_PROPERTY(QSet<QObject *> nodes READ nodes NOTIFY nodesChanged)
    Q_PROPERTY(QSet<QObject *> partitions READ partitions NOTIFY partitionsChanged)
    Q_PROPERTY(QSet<QObject *> structuredNodes READ structuredNodes NOTIFY structuredNodesChanged)
...
public:
    ...
    Q_TODO Q_INVOKABLE const QSet<QObject *> extensions() const;
    ...
    Q_INVOKABLE const QSet<QObject *> groups() const;
    Q_INVOKABLE bool isReadOnly() const;
    Q_INVOKABLE bool isSingleExecution() const;
    Q_INVOKABLE const QSet<QObject *> nodes() const;
    Q_INVOKABLE const QSet<QObject *> partitions() const;
    Q_INVOKABLE const QSet<QObject *> structuredNodes() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Behavior]
    void contextChanged(QObject *context);
    void isReentrantChanged(bool isReentrant);
    ...
    void redefinedBehaviorsChanged(QSet<QObject *> redefinedBehaviors);
    void specificationChanged(QObject *specification);

    // Signals for owned attributes [Activity]
    void edgesChanged(QSet<QObject *> edges);
    void groupsChanged(QSet<QObject *> groups);
    void isReadOnlyChanged(bool isReadOnly);
    void isSingleExecutionChanged(bool isSingleExecution);
    void nodesChanged(QSet<QObject *> nodes);
    void partitionsChanged(QSet<QObject *> partitions);
    void structuredNodesChanged(QSet<QObject *> structuredNodes);
