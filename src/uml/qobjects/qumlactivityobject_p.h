...
class Q_UML_EXPORT QUmlActivityObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> groups READ groups)
    ...
    Q_PROPERTY(QSet<QObject *> partitions READ partitions)
    Q_PROPERTY(QSet<QObject *> structuredNodes READ structuredNodes)
