...
QUmlOpaqueActionObject::QUmlOpaqueActionObject(QUmlOpaqueAction *modelingElement)
{
...
void QUmlOpaqueActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlOpaqueAction, bodies, PropertyTypeRole, QStringLiteral("QList<QString>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlOpaqueAction, inputValues, PropertyTypeRole, QStringLiteral("QSet<QUmlInputPin *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlOpaqueAction, languages, PropertyTypeRole, QStringLiteral("QList<QString>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlOpaqueAction, outputValues, PropertyTypeRole, QStringLiteral("QSet<QUmlOutputPin *>"));
