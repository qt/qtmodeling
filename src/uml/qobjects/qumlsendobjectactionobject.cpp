...
void QUmlSendObjectActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlSendObjectAction, request, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlSendObjectAction, target, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
