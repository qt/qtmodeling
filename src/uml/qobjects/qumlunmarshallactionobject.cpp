...
void QUmlUnmarshallActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlUnmarshallAction, object, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlUnmarshallAction, results, PropertyTypeRole, QStringLiteral("QSet<QUmlOutputPin *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlUnmarshallAction, unmarshallType, PropertyTypeRole, QStringLiteral("QUmlClassifier *"));
