...
class Q_UML_EXPORT QUmlActivityParameterNodeObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * parameter READ parameter WRITE setParameter NOTIFY parameterChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ActivityParameterNode]
    void parameterChanged(QObject *parameter);
