...
class Q_UML_EXPORT QUmlCollaborationUseObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> roleBindings READ roleBindings NOTIFY roleBindingsChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [CollaborationUse]
    void roleBindingsChanged(QSet<QObject *> roleBindings);
