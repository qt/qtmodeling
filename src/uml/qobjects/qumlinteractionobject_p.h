...
class Q_UML_EXPORT QUmlInteractionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> actions READ actions NOTIFY actionsChanged)
    Q_PROPERTY(QSet<QObject *> formalGates READ formalGates NOTIFY formalGatesChanged)
    Q_PROPERTY(QList<QObject *> fragments READ fragments NOTIFY fragmentsChanged)
    Q_PROPERTY(QSet<QObject *> lifelines READ lifelines NOTIFY lifelinesChanged)
    Q_PROPERTY(QSet<QObject *> messages READ messages NOTIFY messagesChanged)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> actions() const;
    Q_INVOKABLE const QSet<QObject *> formalGates() const;
    Q_INVOKABLE const QList<QObject *> fragments() const;
    Q_INVOKABLE const QSet<QObject *> lifelines() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Interaction]
    void actionsChanged(QSet<QObject *> actions);
    void formalGatesChanged(QSet<QObject *> formalGates);
    void fragmentsChanged(QList<QObject *> fragments);
    void lifelinesChanged(QSet<QObject *> lifelines);
    void messagesChanged(QSet<QObject *> messages);
