...
class Q_UML_EXPORT QUmlSequenceNodeObject : public QModelingObject
{
    ...
    Q_PROPERTY(QList<QObject *> executableNodes READ executableNodes NOTIFY executableNodesChanged)
...
public:
    ...
    Q_INVOKABLE const QList<QObject *> executableNodes() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [SequenceNode]
    void executableNodesChanged(QList<QObject *> executableNodes);
