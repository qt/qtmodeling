...
void QUmlProfileObject::addMetaclassReference(QObject *metaclassReference)
{
    ...
    emit metaclassReferencesChanged(this->metaclassReferences());
}
...
void QUmlProfileObject::addMetamodelReference(QObject *metamodelReference)
{
    ...
    emit metamodelReferencesChanged(this->metamodelReferences());
}
...
void QUmlProfileObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlProfile, metaclassReferences, PropertyTypeRole, QStringLiteral("QSet<QUmlElementImport *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlProfile, metamodelReferences, PropertyTypeRole, QStringLiteral("QSet<QUmlPackageImport *>"));
