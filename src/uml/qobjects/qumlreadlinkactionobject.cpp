...
QUmlReadLinkActionObject::QUmlReadLinkActionObject(QUmlReadLinkAction *modelingElement)
{
...
void QUmlReadLinkActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadLinkAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
