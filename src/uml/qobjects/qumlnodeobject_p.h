...
class Q_UML_EXPORT QUmlNodeObject : public QModelingObject
{
    ...
    // Properties [Node]
    Q_PROPERTY(QSet<QObject *> nestedNodes READ nestedNodes NOTIFY nestedNodesChanged)

public:
    Q_INVOKABLE explicit QUmlNodeObject(QUmlNode *modelingElement);
    ...
    Q_INVOKABLE const QSet<QObject *> nestedNodes() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Node]
    void nestedNodesChanged(QSet<QObject *> nestedNodes);
