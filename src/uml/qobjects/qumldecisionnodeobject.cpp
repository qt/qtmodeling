...
void QUmlDecisionNodeObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlDecisionNode, decisionInput, PropertyTypeRole, QStringLiteral("QUmlBehavior *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlDecisionNode, decisionInputFlow, PropertyTypeRole, QStringLiteral("QUmlObjectFlow *"));
