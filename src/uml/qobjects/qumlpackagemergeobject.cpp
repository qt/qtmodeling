...
void QUmlPackageMergeObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlPackageMerge, mergedPackage, PropertyTypeRole, QStringLiteral("QUmlPackage *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlPackageMerge, receivingPackage, PropertyTypeRole, QStringLiteral("QUmlPackage *"));
