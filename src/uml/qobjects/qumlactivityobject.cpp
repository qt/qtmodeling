...
void QUmlActivityObject::setSingleExecution(bool isSingleExecution)
{
    ...
    emit isSingleExecutionChanged(this->isSingleExecution());
}
...
void QUmlActivityObject::addPartition(QObject *partition)
{
    ...
    emit partitionsChanged(this->partitions());
}
...
void QUmlActivityObject::addStructuredNode(QObject *structuredNode)
{
    ...
    emit structuredNodesChanged(this->structuredNodes());
}
...
void QUmlActivityObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlActivity, edges, PropertyTypeRole, QStringLiteral("QSet<QUmlActivityEdge *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlActivity, groups, PropertyTypeRole, QStringLiteral("QSet<QUmlActivityGroup *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlActivity, isReadOnly, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlActivity, isSingleExecution, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlActivity, nodes, PropertyTypeRole, QStringLiteral("QSet<QUmlActivityNode *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlActivity, partitions, PropertyTypeRole, QStringLiteral("QSet<QUmlActivityPartition *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlActivity, structuredNodes, PropertyTypeRole, QStringLiteral("QSet<QUmlStructuredActivityNode *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlActivity, variables, PropertyTypeRole, QStringLiteral("QSet<QUmlVariable *>"));
