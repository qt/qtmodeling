...
class Q_UML_EXPORT QUmlInformationItemObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> represented READ represented NOTIFY representedChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [InformationItem]
    void representedChanged(QSet<QObject *> represented);
