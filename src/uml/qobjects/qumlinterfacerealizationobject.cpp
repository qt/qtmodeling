...
void QUmlInterfaceRealizationObject::setContract(QObject *contract)
{
    ...
    emit contractChanged(this->contract());
}
...
void QUmlInterfaceRealizationObject::setImplementingClassifier(QObject *implementingClassifier)
{
    ...
    emit implementingClassifierChanged(this->implementingClassifier());
}
...
void QUmlInterfaceRealizationObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlAbstraction, mapping, PropertyTypeRole, QStringLiteral("QUmlOpaqueExpression *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterfaceRealization, contract, PropertyTypeRole, QStringLiteral("QUmlInterface *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterfaceRealization, implementingClassifier, PropertyTypeRole, QStringLiteral("QUmlBehavioredClassifier *"));
