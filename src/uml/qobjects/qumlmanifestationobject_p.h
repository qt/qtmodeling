...
class Q_UML_EXPORT QUmlManifestationObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * utilizedElement READ utilizedElement WRITE setUtilizedElement NOTIFY utilizedElementChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Manifestation]
    void utilizedElementChanged(QObject *utilizedElement);
