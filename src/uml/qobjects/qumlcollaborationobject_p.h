...
class Q_UML_EXPORT QUmlCollaborationObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> collaborationRoles READ collaborationRoles NOTIFY collaborationRolesChanged)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> collaborationRoles() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Collaboration]
    void collaborationRolesChanged(QSet<QObject *> collaborationRoles);
