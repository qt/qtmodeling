...
void QUmlExtensionObject::setRequired(bool isRequired)
{
    ...
    emit isRequiredChanged(this->isRequired());
}
...
void QUmlExtensionObject::unsetRequired()
{
    Q_D(QModelingObject);
    setRequired(false);
    d->modifiedResettableProperties.removeAll(QStringLiteral("isRequired"));
}
...
void QUmlExtensionObject::setMetaclass(QObject *metaclass)
{
    ...
    emit metaclassChanged(this->metaclass());
}
...
void QUmlExtensionObject::setOwnedEnd(QObject *ownedEnd)
{
    ...
    emit ownedEndChanged(this->ownedEnd());
}
...
void QUmlExtensionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExtension, isRequired, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExtension, metaclass, PropertyTypeRole, QStringLiteral("QUmlClass *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExtension, ownedEnd, PropertyTypeRole, QStringLiteral("QUmlExtensionEnd *"));
