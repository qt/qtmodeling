...
void QUmlConditionalNodeObject::unsetAssured()
{
    Q_D(QModelingObject);
    setAssured(false);
    d->modifiedResettableProperties.removeAll(QStringLiteral("isAssured"));
}
...
void QUmlConditionalNodeObject::unsetDeterminate()
{
    ...
    d->modifiedResettableProperties.removeAll(QStringLiteral("isDeterminate"));
}
...
void QUmlConditionalNodeObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlConditionalNode, clauses, PropertyTypeRole, QStringLiteral("QSet<QUmlClause *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlConditionalNode, isAssured, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlConditionalNode, isDeterminate, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlConditionalNode, results, PropertyTypeRole, QStringLiteral("QList<QUmlOutputPin *>"));
