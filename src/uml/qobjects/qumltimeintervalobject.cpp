...
void QUmlTimeIntervalObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlTimeInterval, max, PropertyTypeRole, QStringLiteral("QUmlTimeExpression *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlTimeInterval, min, PropertyTypeRole, QStringLiteral("QUmlTimeExpression *"));
