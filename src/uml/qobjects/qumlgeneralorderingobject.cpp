...
void QUmlGeneralOrderingObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlGeneralOrdering, after, PropertyTypeRole, QStringLiteral("QUmlOccurrenceSpecification *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlGeneralOrdering, before, PropertyTypeRole, QStringLiteral("QUmlOccurrenceSpecification *"));
