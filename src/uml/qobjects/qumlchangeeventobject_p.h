...
class Q_UML_EXPORT QUmlChangeEventObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * changeExpression READ changeExpression WRITE setChangeExpression NOTIFY changeExpressionChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ChangeEvent]
    void changeExpressionChanged(QObject *changeExpression);
