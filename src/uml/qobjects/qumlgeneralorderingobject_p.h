...
class Q_UML_EXPORT QUmlGeneralOrderingObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * after READ after WRITE setAfter NOTIFY afterChanged)
    Q_PROPERTY(QObject * before READ before WRITE setBefore NOTIFY beforeChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [GeneralOrdering]
    void afterChanged(QObject *after);
    void beforeChanged(QObject *before);
