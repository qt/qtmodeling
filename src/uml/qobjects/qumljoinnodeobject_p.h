...
class Q_UML_EXPORT QUmlJoinNodeObject : public QModelingObject
{
    ...
    // Properties [JoinNode]
    Q_PROPERTY(bool isCombineDuplicate READ isCombineDuplicate WRITE setCombineDuplicate NOTIFY isCombineDuplicateChanged RESET unsetCombineDuplicate)
    Q_PROPERTY(QObject * joinSpec READ joinSpec WRITE setJoinSpec NOTIFY joinSpecChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [JoinNode]
    void isCombineDuplicateChanged(bool isCombineDuplicate);
    void joinSpecChanged(QObject *joinSpec);
