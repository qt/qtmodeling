...
void QUmlReadLinkObjectEndActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadLinkObjectEndAction, end, PropertyTypeRole, QStringLiteral("QUmlProperty *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadLinkObjectEndAction, object, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReadLinkObjectEndAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
