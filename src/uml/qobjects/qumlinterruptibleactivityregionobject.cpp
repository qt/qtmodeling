...
void QUmlInterruptibleActivityRegionObject::addInterruptingEdge(QObject *interruptingEdge)
{
    ...
    emit interruptingEdgesChanged(this->interruptingEdges());
}
...
void QUmlInterruptibleActivityRegionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterruptibleActivityRegion, interruptingEdges, PropertyTypeRole, QStringLiteral("QSet<QUmlActivityEdge *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlInterruptibleActivityRegion, nodes, PropertyTypeRole, QStringLiteral("QSet<QUmlActivityNode *>"));
