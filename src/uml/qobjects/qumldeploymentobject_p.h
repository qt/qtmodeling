...
class Q_UML_EXPORT QUmlDeploymentObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> configurations READ configurations NOTIFY configurationsChanged)
    Q_PROPERTY(QSet<QObject *> deployedArtifacts READ deployedArtifacts NOTIFY deployedArtifactsChanged)
    Q_PROPERTY(QObject * location READ location WRITE setLocation NOTIFY locationChanged)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> configurations() const;
    Q_INVOKABLE const QSet<QObject *> deployedArtifacts() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Deployment]
    void configurationsChanged(QSet<QObject *> configurations);
    void deployedArtifactsChanged(QSet<QObject *> deployedArtifacts);
    void locationChanged(QObject *location);
