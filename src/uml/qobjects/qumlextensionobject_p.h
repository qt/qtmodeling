...
class Q_UML_EXPORT QUmlExtensionObject : public QModelingObject
{
    ...
    Q_PROPERTY(bool isRequired READ isRequired NOTIFY isRequiredChanged RESET unsetRequired STORED false)
    Q_PROPERTY(QObject * metaclass READ metaclass NOTIFY metaclassChanged STORED false)
    Q_PROPERTY(QObject * ownedEnd READ ownedEnd WRITE setOwnedEnd NOTIFY ownedEndChanged)

public:
    Q_INVOKABLE explicit QUmlExtensionObject(QUmlExtension *modelingElement);
    ...
    Q_TODO Q_INVOKABLE bool isRequired() const;
    Q_TODO Q_INVOKABLE QObject *metaclass() const;
    ...
    Q_TODO Q_INVOKABLE QObject *metaclassEnd() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Extension]
    void isRequiredChanged(bool isRequired);
    void metaclassChanged(QObject *metaclass);
    void ownedEndChanged(QObject *ownedEnd);
