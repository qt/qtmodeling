...
class Q_UML_EXPORT QUmlUseCaseObject : public QModelingObject
{
    ...
    // Properties [UseCase]
    Q_PROPERTY(QSet<QObject *> extends READ extends)
    Q_PROPERTY(QSet<QObject *> extensionPoints READ extensionPoints)
    Q_PROPERTY(QSet<QObject *> includes READ includes)
