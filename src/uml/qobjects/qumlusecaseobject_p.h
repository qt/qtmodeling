...
class Q_UML_EXPORT QUmlUseCaseObject : public QModelingObject
{
    ...
    // Properties [UseCase]
    Q_PROPERTY(QSet<QObject *> extends READ extends NOTIFY extendsChanged)
    Q_PROPERTY(QSet<QObject *> extensionPoints READ extensionPoints NOTIFY extensionPointsChanged)
    Q_PROPERTY(QSet<QObject *> includes READ includes NOTIFY includesChanged)
    Q_PROPERTY(QSet<QObject *> subjects READ subjects NOTIFY subjectsChanged)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> extends() const;
    Q_INVOKABLE const QSet<QObject *> extensionPoints() const;
    Q_INVOKABLE const QSet<QObject *> includes() const;
    Q_INVOKABLE const QSet<QObject *> subjects() const;
    ...
    // Operations [UseCase]
    Q_TODO Q_INVOKABLE QSet<QObject *> allIncludedUseCases() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [UseCase]
    void extendsChanged(QSet<QObject *> extends);
    void extensionPointsChanged(QSet<QObject *> extensionPoints);
    void includesChanged(QSet<QObject *> includes);
    void subjectsChanged(QSet<QObject *> subjects);
