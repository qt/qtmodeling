...
class Q_UML_EXPORT QUmlUseCaseObject : public QObject
{
    ...
    // Properties [UseCase]
    Q_PROPERTY(QSet<QObject *> extend READ extends)
    Q_PROPERTY(QSet<QObject *> extensionPoint READ extensionPoints)
    Q_PROPERTY(QSet<QObject *> include READ includes)
    Q_PROPERTY(QSet<QObject *> subject READ subjects)
