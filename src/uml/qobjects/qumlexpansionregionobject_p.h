...
class Q_UML_EXPORT QUmlExpansionRegionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> inputElements READ inputElements NOTIFY inputElementsChanged)
    Q_PROPERTY(QtUml::ExpansionKind mode READ mode WRITE setMode NOTIFY modeChanged RESET unsetMode)
    Q_PROPERTY(QSet<QObject *> outputElements READ outputElements NOTIFY outputElementsChanged)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> inputElements() const;
    Q_INVOKABLE QtUml::ExpansionKind mode() const;
    Q_INVOKABLE const QSet<QObject *> outputElements() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ExpansionRegion]
    void inputElementsChanged(QSet<QObject *> inputElements);
    void modeChanged(QtUml::ExpansionKind mode);
    void outputElementsChanged(QSet<QObject *> outputElements);
