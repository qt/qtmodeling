...
void QUmlTimeConstraintObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlTimeConstraint, firstEvent, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlTimeConstraint, specification, PropertyTypeRole, QStringLiteral("QUmlTimeInterval *"));
