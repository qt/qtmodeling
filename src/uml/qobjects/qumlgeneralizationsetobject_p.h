...
class Q_UML_EXPORT QUmlGeneralizationSetObject : public QModelingObject
{
    ...
    Q_PROPERTY(bool isCovering READ isCovering WRITE setCovering NOTIFY isCoveringChanged RESET unsetCovering)
    Q_PROPERTY(bool isDisjoint READ isDisjoint WRITE setDisjoint NOTIFY isDisjointChanged RESET unsetDisjoint)
    Q_PROPERTY(QObject * powertype READ powertype WRITE setPowertype NOTIFY powertypeChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [GeneralizationSet]
    void generalizationsChanged(QSet<QObject *> generalizations);
    void isCoveringChanged(bool isCovering);
    void isDisjointChanged(bool isDisjoint);
    void powertypeChanged(QObject *powertype);
