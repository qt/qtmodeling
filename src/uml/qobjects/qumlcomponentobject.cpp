...
void QUmlComponentObject::setIndirectlyInstantiated(bool isIndirectlyInstantiated)
{
    ...
    emit isIndirectlyInstantiatedChanged(this->isIndirectlyInstantiated());
}
...
void QUmlComponentObject::unsetIndirectlyInstantiated()
{
    ...
    d->modifiedResettableProperties.removeAll(QStringLiteral("isIndirectlyInstantiated"));
}
...
void QUmlComponentObject::addRealization(QObject *realization)
{
    ...
    emit realizationsChanged(this->realizations());
}
...
void QUmlComponentObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlComponent, isIndirectlyInstantiated, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlComponent, packagedElements, PropertyTypeRole, QStringLiteral("QSet<QUmlPackageableElement *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlComponent, provided, PropertyTypeRole, QStringLiteral("QSet<QUmlInterface *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlComponent, realizations, PropertyTypeRole, QStringLiteral("QSet<QUmlComponentRealization *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlComponent, required, PropertyTypeRole, QStringLiteral("QSet<QUmlInterface *>"));
