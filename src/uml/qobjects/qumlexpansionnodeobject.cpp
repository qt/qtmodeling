...
void QUmlExpansionNodeObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExpansionNode, regionAsInput, PropertyTypeRole, QStringLiteral("QUmlExpansionRegion *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExpansionNode, regionAsOutput, PropertyTypeRole, QStringLiteral("QUmlExpansionRegion *"));
