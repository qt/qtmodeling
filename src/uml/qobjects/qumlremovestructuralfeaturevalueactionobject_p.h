...
class Q_UML_EXPORT QUmlRemoveStructuralFeatureValueActionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * structuralFeature READ structuralFeature WRITE setStructuralFeature NOTIFY structuralFeatureChanged)
    ...
    Q_PROPERTY(bool isRemoveDuplicates READ isRemoveDuplicates WRITE setRemoveDuplicates NOTIFY isRemoveDuplicatesChanged RESET unsetRemoveDuplicates)
    Q_PROPERTY(QObject * removeAt READ removeAt WRITE setRemoveAt NOTIFY removeAtChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [StructuralFeatureAction]
    void objectChanged(QObject *object);
    void structuralFeatureChanged(QObject *structuralFeature);

    // Signals for owned attributes [WriteStructuralFeatureAction]
    void resultChanged(QObject *result);
    void valueChanged(QObject *value);

    // Signals for owned attributes [RemoveStructuralFeatureValueAction]
    void isRemoveDuplicatesChanged(bool isRemoveDuplicates);
    void removeAtChanged(QObject *removeAt);
