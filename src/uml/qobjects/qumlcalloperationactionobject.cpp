...
void QUmlCallOperationActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCallOperationAction, operation, PropertyTypeRole, QStringLiteral("QUmlOperation *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCallOperationAction, target, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
