...
void QUmlExecutionOccurrenceSpecificationObject::setExecution(QObject *execution)
{
    ...
    emit executionChanged(this->execution());
}
...
void QUmlExecutionOccurrenceSpecificationObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExecutionOccurrenceSpecification, execution, PropertyTypeRole, QStringLiteral("QUmlExecutionSpecification *"));
