...
public:
    ...
    Q_TODO Q_INVOKABLE QSet<QObject *> realizedInterfaces(QObject *classifier) const;
    Q_TODO Q_INVOKABLE QSet<QObject *> usedInterfaces(QObject *classifier) const;
...
public Q_SLOTS:
    ...
    void unsetIndirectlyInstantiated();
