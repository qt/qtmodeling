...
void QUmlJoinNodeObject::setCombineDuplicate(bool isCombineDuplicate)
{
    ...
    emit isCombineDuplicateChanged(this->isCombineDuplicate());
}
...
void QUmlJoinNodeObject::setJoinSpec(QObject *joinSpec)
{
    ...
    emit joinSpecChanged(this->joinSpec());
}
...
void QUmlJoinNodeObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlJoinNode, isCombineDuplicate, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlJoinNode, joinSpec, PropertyTypeRole, QStringLiteral("QUmlValueSpecification *"));
