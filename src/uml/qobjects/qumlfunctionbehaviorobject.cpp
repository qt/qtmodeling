...
void QUmlFunctionBehaviorObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlOpaqueBehavior, bodies, PropertyTypeRole, QStringLiteral("QList<QString>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlOpaqueBehavior, languages, PropertyTypeRole, QStringLiteral("QList<QString>"));
