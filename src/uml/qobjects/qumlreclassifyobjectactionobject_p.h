...
class Q_UML_EXPORT QUmlReclassifyObjectActionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> newClassifiers READ newClassifiers NOTIFY newClassifiersChanged)
    Q_PROPERTY(QObject * object READ object WRITE setObject NOTIFY objectChanged)
    Q_PROPERTY(QSet<QObject *> oldClassifiers READ oldClassifiers NOTIFY oldClassifiersChanged)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> newClassifiers() const;
    Q_INVOKABLE QObject *object() const;
    Q_INVOKABLE const QSet<QObject *> oldClassifiers() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ReclassifyObjectAction]
    void isReplaceAllChanged(bool isReplaceAll);
    void newClassifiersChanged(QSet<QObject *> newClassifiers);
    void objectChanged(QObject *object);
    void oldClassifiersChanged(QSet<QObject *> oldClassifiers);
