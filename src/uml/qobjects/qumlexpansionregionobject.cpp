...
void QUmlExpansionRegionObject::addInputElement(QObject *inputElement)
{
    ...
    emit inputElementsChanged(this->inputElements());
}
...
void QUmlExpansionRegionObject::addOutputElement(QObject *outputElement)
{
    ...
    emit outputElementsChanged(this->outputElements());
}
...
void QUmlExpansionRegionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExpansionRegion, inputElements, PropertyTypeRole, QStringLiteral("QSet<QUmlExpansionNode *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExpansionRegion, mode, PropertyTypeRole, QStringLiteral("QtUml::ExpansionKind"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlExpansionRegion, outputElements, PropertyTypeRole, QStringLiteral("QSet<QUmlExpansionNode *>"));
