...
class Q_UML_EXPORT QUmlOpaqueActionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> inputValues READ inputValues NOTIFY inputValuesChanged)
    Q_PROPERTY(QList<QString> languages READ languages NOTIFY languagesChanged)
    Q_PROPERTY(QSet<QObject *> outputValues READ outputValues NOTIFY outputValuesChanged)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> inputValues() const;
    Q_INVOKABLE const QList<QString> languages() const;
    Q_INVOKABLE const QSet<QObject *> outputValues() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [OpaqueAction]
    void bodiesChanged(QList<QString> bodies);
    void inputValuesChanged(QSet<QObject *> inputValues);
    void languagesChanged(QList<QString> languages);
    void outputValuesChanged(QSet<QObject *> outputValues);
