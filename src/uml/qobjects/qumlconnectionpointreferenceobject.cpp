...
void QUmlConnectionPointReferenceObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlConnectionPointReference, entries, PropertyTypeRole, QStringLiteral("QSet<QUmlPseudostate *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlConnectionPointReference, exits, PropertyTypeRole, QStringLiteral("QSet<QUmlPseudostate *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlConnectionPointReference, state, PropertyTypeRole, QStringLiteral("QUmlState *"));
