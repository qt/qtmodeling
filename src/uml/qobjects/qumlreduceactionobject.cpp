...
void QUmlReduceActionObject::setCollection(QObject *collection)
{
    ...
    emit collectionChanged(this->collection());
}
...
void QUmlReduceActionObject::setReducer(QObject *reducer)
{
    ...
    emit reducerChanged(this->reducer());
}
...
void QUmlReduceActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReduceAction, collection, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReduceAction, isOrdered, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReduceAction, reducer, PropertyTypeRole, QStringLiteral("QUmlBehavior *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlReduceAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
