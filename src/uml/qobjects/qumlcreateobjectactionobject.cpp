...
void QUmlCreateObjectActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCreateObjectAction, classifier, PropertyTypeRole, QStringLiteral("QUmlClassifier *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlCreateObjectAction, result, PropertyTypeRole, QStringLiteral("QUmlOutputPin *"));
