...
void QUmlChangeEventObject::setChangeExpression(QObject *changeExpression)
{
    ...
    emit changeExpressionChanged(this->changeExpression());
}
...
void QUmlChangeEventObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlChangeEvent, changeExpression, PropertyTypeRole, QStringLiteral("QUmlValueSpecification *"));
