...
class Q_UML_EXPORT QUmlDeploymentSpecificationObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> manifestations READ manifestations NOTIFY manifestationsChanged)
    Q_PROPERTY(QSet<QObject *> nestedArtifacts READ nestedArtifacts NOTIFY nestedArtifactsChanged)
    ...
    Q_PROPERTY(QObject * deployment READ deployment WRITE setDeployment NOTIFY deploymentChanged)
    Q_PROPERTY(QString deploymentLocation READ deploymentLocation WRITE setDeploymentLocation NOTIFY deploymentLocationChanged)
    Q_PROPERTY(QString executionLocation READ executionLocation WRITE setExecutionLocation NOTIFY executionLocationChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [Artifact]
    void fileNameChanged(QString fileName);
    void manifestationsChanged(QSet<QObject *> manifestations);
    void nestedArtifactsChanged(QSet<QObject *> nestedArtifacts);
    void ownedAttributesChanged(QList<QObject *> ownedAttributes);
    void ownedOperationsChanged(QList<QObject *> ownedOperations);

    // Signals for owned attributes [DeploymentSpecification]
    void deploymentChanged(QObject *deployment);
    void deploymentLocationChanged(QString deploymentLocation);
    void executionLocationChanged(QString executionLocation);
