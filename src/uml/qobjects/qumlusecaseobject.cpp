...
void QUmlUseCaseObject::addExtend(QObject *extend)
{
    ...
    emit extendsChanged(this->extends());
}
...
void QUmlUseCaseObject::addExtensionPoint(QObject *extensionPoint)
{
    ...
    emit extensionPointsChanged(this->extensionPoints());
}
...
void QUmlUseCaseObject::addInclude(QObject *include)
{
    ...
    emit includesChanged(this->includes());
}
...
void QUmlUseCaseObject::addSubject(QObject *subject)
{
    ...
    emit subjectsChanged(this->subjects());
}
...
void QUmlUseCaseObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlUseCase, extends, PropertyTypeRole, QStringLiteral("QSet<QUmlExtend *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlUseCase, extensionPoints, PropertyTypeRole, QStringLiteral("QSet<QUmlExtensionPoint *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlUseCase, includes, PropertyTypeRole, QStringLiteral("QSet<QUmlInclude *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlUseCase, subjects, PropertyTypeRole, QStringLiteral("QSet<QUmlClassifier *>"));
