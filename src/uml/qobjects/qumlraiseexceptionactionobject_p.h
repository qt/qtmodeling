...
class Q_UML_EXPORT QUmlRaiseExceptionActionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * exception READ exception WRITE setException NOTIFY exceptionChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [RaiseExceptionAction]
    void exceptionChanged(QObject *exception);
