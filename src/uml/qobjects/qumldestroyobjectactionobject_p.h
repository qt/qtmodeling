...
class Q_UML_EXPORT QUmlDestroyObjectActionObject : public QModelingObject
{
    ...
    Q_PROPERTY(bool isDestroyLinks READ isDestroyLinks WRITE setDestroyLinks NOTIFY isDestroyLinksChanged RESET unsetDestroyLinks)
    Q_PROPERTY(bool isDestroyOwnedObjects READ isDestroyOwnedObjects WRITE setDestroyOwnedObjects NOTIFY isDestroyOwnedObjectsChanged RESET unsetDestroyOwnedObjects)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [DestroyObjectAction]
    void isDestroyLinksChanged(bool isDestroyLinks);
    void isDestroyOwnedObjectsChanged(bool isDestroyOwnedObjects);
