...
void QUmlStateInvariantObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlStateInvariant, covered, PropertyTypeRole, QStringLiteral("QUmlLifeline *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlStateInvariant, invariant, PropertyTypeRole, QStringLiteral("QUmlConstraint *"));
