...
void QUmlAddVariableValueActionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlAddVariableValueAction, insertAt, PropertyTypeRole, QStringLiteral("QUmlInputPin *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlAddVariableValueAction, isReplaceAll, PropertyTypeRole, QStringLiteral("bool"));
