...
void QUmlTimeExpressionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlTimeExpression, expr, PropertyTypeRole, QStringLiteral("QUmlValueSpecification *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QUmlTimeExpression, observations, PropertyTypeRole, QStringLiteral("QSet<QUmlObservation *>"));
