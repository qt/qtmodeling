...
class Q_UML_EXPORT QUmlBroadcastSignalActionObject : public QModelingObject
{
    ...
    Q_PROPERTY(QObject * signal READ signal WRITE setSignal NOTIFY signalChanged)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [BroadcastSignalAction]
    void signalChanged(QObject *signal);
