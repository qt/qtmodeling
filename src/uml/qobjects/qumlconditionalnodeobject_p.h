...
class Q_UML_EXPORT QUmlConditionalNodeObject : public QModelingObject
{
    ...
    Q_PROPERTY(QSet<QObject *> clauses READ clauses NOTIFY clausesChanged)
    Q_PROPERTY(bool isAssured READ isAssured WRITE setAssured NOTIFY isAssuredChanged RESET unsetAssured)
    Q_PROPERTY(bool isDeterminate READ isDeterminate WRITE setDeterminate NOTIFY isDeterminateChanged RESET unsetDeterminate)
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [ConditionalNode]
    void clausesChanged(QSet<QObject *> clauses);
    void isAssuredChanged(bool isAssured);
    void isDeterminateChanged(bool isDeterminate);
