...
public:
    Q_INVOKABLE explicit QNamedElement(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QNamedElement(QNamedElementPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
