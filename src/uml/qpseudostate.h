...
public:
    Q_INVOKABLE explicit QPseudostate(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QPseudostate(QPseudostatePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
