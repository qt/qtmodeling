...
#include "QtUml/QReadVariableAction"
...
class Q_UML_EXPORT QReadVariableActionPrivate : public QVariableActionPrivate
{
    Q_DECLARE_PUBLIC(QReadVariableAction)
...
#endif // QTUML_QREADVARIABLEACTION_P_H
