...
public:
    Q_INVOKABLE explicit QDurationConstraint(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QDurationConstraint(QDurationConstraintPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
