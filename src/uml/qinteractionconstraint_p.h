...
class Q_UML_EXPORT QInteractionConstraintPrivate : public QConstraintPrivate
{
    Q_DECLARE_PUBLIC(QInteractionConstraint)
...
#endif // QTUML_QINTERACTIONCONSTRAINT_P_H
