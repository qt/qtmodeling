...
void QObjectNode::setPropertyData()
{
    ...
    QWrappedObject::propertyDataHash[QString::fromLatin1("QObjectNode")][QString::fromLatin1("upperBound")][QtWrappedObjects::QtWrappedObjects::SubsettedPropertiesRole] = QString::fromLatin1("QElement::ownedElement");
