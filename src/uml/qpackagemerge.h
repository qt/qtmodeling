...
public:
    Q_INVOKABLE explicit QPackageMerge(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QPackageMerge(QPackageMergePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
