...
class Q_UML_EXPORT QUmlMultiplicityElementPrivate : public QUmlElementPrivate
{
    Q_DECLARE_PUBLIC(QUmlMultiplicityElement)

public:
    explicit QUmlMultiplicityElementPrivate();
    virtual ~QUmlMultiplicityElementPrivate();
