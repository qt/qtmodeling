...
public:
    Q_INVOKABLE explicit QGeneralizationSet(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QGeneralizationSet(QGeneralizationSetPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
