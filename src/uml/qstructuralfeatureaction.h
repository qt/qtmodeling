...
**
****************************************************************************/
#ifndef QTUML_QSTRUCTURALFEATUREACTION_H
#define QTUML_QSTRUCTURALFEATUREACTION_H
...
public:
    Q_INVOKABLE explicit QStructuralFeatureAction(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
