...
class Q_UML_EXPORT QBroadcastSignalAction : public QInvocationAction
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QBroadcastSignalAction(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
