...
Q_DECLARE_METATYPE(QSet<QT_PREPEND_NAMESPACE_QTUML(QRemoveVariableValueAction) *> *)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QRemoveVariableValueAction) *> *)
