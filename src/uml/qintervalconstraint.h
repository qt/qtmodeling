...
public:
    Q_INVOKABLE explicit QIntervalConstraint(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QIntervalConstraint(QIntervalConstraintPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
