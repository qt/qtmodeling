...
public:
    Q_INVOKABLE explicit QQualifierValue(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QQualifierValue(QQualifierValuePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
