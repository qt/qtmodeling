...
class Q_UML_EXPORT QCallBehaviorAction : public QObject, public QCallAction
{
    Q_OBJECT
...
protected:
    explicit QCallBehaviorAction(bool createPimpl, QObject *parent = 0);
};

QT_END_NAMESPACE_QTUML

Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QCallBehaviorAction) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QCallBehaviorAction) *> *)
