...
public:
    Q_INVOKABLE explicit QInitialNode(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QInitialNode();

protected:
    explicit QInitialNode(QInitialNodePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
