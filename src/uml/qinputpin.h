...
public:
    Q_INVOKABLE explicit QInputPin(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QInputPin();

protected:
    explicit QInputPin(QInputPinPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
