...
class Q_UML_EXPORT QAcceptEventAction : public QObject, public QAction
{
    Q_OBJECT
...
Q_DECLARE_METATYPE(QList<QtUml::QAcceptEventAction *>)
Q_DECLARE_METATYPE(QList<QtUml::QAcceptEventAction *> *)
