...
public:
    Q_INVOKABLE explicit QAcceptEventAction(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QAcceptEventAction(QAcceptEventActionPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
