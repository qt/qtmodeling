...
Q_DECLARE_METATYPE(QSet<QT_PREPEND_NAMESPACE_QTUML(QAddStructuralFeatureValueAction) *> *)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_QTUML(QAddStructuralFeatureValueAction) *> *)
