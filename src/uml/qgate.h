...
**
****************************************************************************/
#ifndef QTUML_QGATE_H
#define QTUML_QGATE_H
...
public:
    Q_INVOKABLE explicit QGate(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
    virtual ~QGate();

protected:
    explicit QGate(QGatePrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
