...
public:
    Q_INVOKABLE explicit QStructuredClassifier(QUmlObject *parent = 0, QUmlObject *wrapper = 0);
...
protected:
    explicit QStructuredClassifier(QStructuredClassifierPrivate &dd, QUmlObject *parent = 0, QUmlObject *wrapper = 0);
};
