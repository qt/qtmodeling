...
**
****************************************************************************/
#ifndef CLASSES_KERNEL_QSLOT_H
#define CLASSES_KERNEL_QSLOT_H
...
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_UML_CLASSES_KERNEL(QSlot) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_UML_CLASSES_KERNEL(QSlot) *> *)

QT_END_HEADER

#endif // CLASSES_KERNEL_QSLOT_H
