...
**
****************************************************************************/
#ifndef CLASSES_KERNEL_QINSTANCEVALUE_H
#define CLASSES_KERNEL_QINSTANCEVALUE_H
...
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_UML_CLASSES_KERNEL(QInstanceValue) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_UML_CLASSES_KERNEL(QInstanceValue) *> *)

QT_END_HEADER

#endif // CLASSES_KERNEL_QINSTANCEVALUE_H
