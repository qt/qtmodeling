...
**
****************************************************************************/
#ifndef CLASSES_KERNEL_QPACKAGEMERGE_H
#define CLASSES_KERNEL_QPACKAGEMERGE_H
...
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_UML_CLASSES_KERNEL(QPackageMerge) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_UML_CLASSES_KERNEL(QPackageMerge) *> *)

QT_END_HEADER

#endif // CLASSES_KERNEL_QPACKAGEMERGE_H
