...
**
****************************************************************************/
#ifndef CLASSES_KERNEL_QCONSTRAINT_H
#define CLASSES_KERNEL_QCONSTRAINT_H
...
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_UML_CLASSES_KERNEL(QConstraint) *>)
Q_DECLARE_METATYPE(QList<QT_PREPEND_NAMESPACE_UML_CLASSES_KERNEL(QConstraint) *> *)

QT_END_HEADER

#endif // CLASSES_KERNEL_QCONSTRAINT_H
