...
class Q_MODELINGWIDGETS_EXPORT HintLineEdit : public QLineEdit
{
    Q_OBJECT
...
class Q_MODELINGWIDGETS_EXPORT IconButton: public QToolButton
{
    Q_OBJECT
...
class Q_MODELINGWIDGETS_EXPORT FilterWidget : public QWidget
{
    Q_OBJECT
