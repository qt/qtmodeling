...
**
****************************************************************************/
#ifndef QTMOF_QINSTANCEVALUE_H
#define QTMOF_QINSTANCEVALUE_H
...
class Q_MOF_EXPORT QInstanceValue : public QValueSpecification
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QInstanceValue(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
