...
void QNamespace::setPropertyData()
{
    ...
    QWrappedObject::propertyDataHash[QString::fromLatin1("QNamespace")][QString::fromLatin1("ownedMembers")][QtWrappedObjects::QtWrappedObjects::SubsettedPropertiesRole] = QString::fromLatin1("QElement::ownedElement QNamespace::member");
