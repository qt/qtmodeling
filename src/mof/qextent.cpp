...
QExtent::QExtent(QWrappedObject *wrapper, QWrappedObject *parent) :
    QMofObject(*new QExtentPrivate, wrapper, parent)
{
    setPropertyData();
}

QExtent::QExtent(QExtentPrivate &dd, QWrappedObject *wrapper, QWrappedObject *parent) :
