...
**
****************************************************************************/
#ifndef QTMOF_QINSTANCESPECIFICATION_P_H
#define QTMOF_QINSTANCESPECIFICATION_P_H
...
class Q_MOF_EXPORT QInstanceSpecificationPrivate : public QPackageableElementPrivate
{
...
#endif // QTMOF_QINSTANCESPECIFICATION_P_H
