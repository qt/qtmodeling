...
**
****************************************************************************/
#ifndef QTMOF_QREDEFINABLEELEMENT_H
#define QTMOF_QREDEFINABLEELEMENT_H
...
class Q_MOF_EXPORT QRedefinableElement : public QNamedElement
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit QRedefinableElement(QWrappedObject *wrapper = 0, QWrappedObject *parent = 0);
