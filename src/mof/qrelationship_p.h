...
**
****************************************************************************/
#ifndef QTMOF_QRELATIONSHIP_P_H
#define QTMOF_QRELATIONSHIP_P_H
...
class Q_MOF_EXPORT QRelationshipPrivate : public QElementPrivate
{
