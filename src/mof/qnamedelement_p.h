...
**
****************************************************************************/
#ifndef QTMOF_QNAMEDELEMENT_P_H
#define QTMOF_QNAMEDELEMENT_P_H
...
class Q_MOF_EXPORT QNamedElementPrivate : public QElementPrivate
{
