...
**
****************************************************************************/
#ifndef QMOFINSTANCESPECIFICATIONOBJECT_H
#define QMOFINSTANCESPECIFICATIONOBJECT_H
...
class Q_MOF_EXPORT QMofInstanceSpecificationObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofInstanceSpecificationObject)
...
#endif // QMOFINSTANCESPECIFICATIONOBJECT_H
