...
**
****************************************************************************/
#ifndef QMOFINSTANCEVALUEOBJECT_H
#define QMOFINSTANCEVALUEOBJECT_H
...
class Q_MOF_EXPORT QMofInstanceValueObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofInstanceValueObject)
    ...
    Q_PROPERTY(QObject * instance READ instance WRITE setInstance NOTIFY instanceChanged)

public:
    Q_INVOKABLE explicit QMofInstanceValueObject(QMofInstanceValue *modelingElement);
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [InstanceValue]
    void instanceChanged(QObject *instance);
...
#endif // QMOFINSTANCEVALUEOBJECT_H
