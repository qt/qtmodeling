...
**
****************************************************************************/
#include "qmofinstancespecificationobject_p.h"
...
QMofInstanceSpecificationObject::QMofInstanceSpecificationObject(QMofInstanceSpecification *modelingElement)
{
...
const QSet<QObject *> QMofInstanceSpecificationObject::ownedComments() const
{
    QSet<QObject *> set;
    foreach (QMofComment *element, qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->ownedComments())
        set.insert(element->asQModelingObject());
    return set;
}

const QSet<QObject *> QMofInstanceSpecificationObject::ownedElements() const
{
    QSet<QObject *> set;
    foreach (QMofElement *element, qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->ownedElements())
        set.insert(element->asQModelingObject());
    return set;
}

QObject *QMofInstanceSpecificationObject::owner() const
{
    if (!qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->owner())
        return 0;
    else
        return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->owner()->asQModelingObject();
}

// OWNED ATTRIBUTES [NamedElement]

QString QMofInstanceSpecificationObject::name() const
{
    return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->name();
}

QObject *QMofInstanceSpecificationObject::namespace_() const
{
    if (!qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->namespace_())
        return 0;
    else
        return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->namespace_()->asQModelingObject();
}

QString QMofInstanceSpecificationObject::qualifiedName() const
{
    return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->qualifiedName();
}

// OWNED ATTRIBUTES [PackageableElement]

QtMof::VisibilityKind QMofInstanceSpecificationObject::visibility() const
{
    return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->visibility();
}

// OWNED ATTRIBUTES [InstanceSpecification]

const QSet<QObject *> QMofInstanceSpecificationObject::classifiers() const
{
    QSet<QObject *> set;
    foreach (QMofClassifier *element, qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->classifiers())
        set.insert(element->asQModelingObject());
    return set;
}

const QSet<QObject *> QMofInstanceSpecificationObject::slots_() const
{
    QSet<QObject *> set;
    foreach (QMofSlot *element, qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->slots_())
        set.insert(element->asQModelingObject());
    return set;
}

QObject *QMofInstanceSpecificationObject::specification() const
{
    if (!qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->specification())
        return 0;
    else
        return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->specification()->asQModelingObject();
}

// OPERATIONS [Element]

QSet<QObject *> QMofInstanceSpecificationObject::allOwnedElements() const
{
    QSet<QObject *> set;
    foreach (QMofElement *element, qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->allOwnedElements())
        set.insert(element->asQModelingObject());
    return set;
}

bool QMofInstanceSpecificationObject::mustBeOwned() const
{
    return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->mustBeOwned();
}

QObject *QMofInstanceSpecificationObject::getMetaClass() const
{
    if (!qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->getMetaClass())
        return 0;
    else
        return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->getMetaClass()->asQModelingObject();
}

QObject *QMofInstanceSpecificationObject::container() const
{
    if (!qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->container())
        return 0;
    else
        return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->container()->asQModelingObject();
}

bool QMofInstanceSpecificationObject::isInstanceOfType(QObject *type, bool includesSubtypes) const
{
    return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->isInstanceOfType(qmodelingelementproperty_cast<QMofClass *>(type), includesSubtypes);
}

void QMofInstanceSpecificationObject::delete_()
{
    return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->delete_();
}

// OPERATIONS [NamedElement]

QList<QObject *> QMofInstanceSpecificationObject::allNamespaces() const
{
    QList<QObject *> set;
    foreach (QMofNamespace *element, qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->allNamespaces())
        set.append(element->asQModelingObject());
    return set;
}

bool QMofInstanceSpecificationObject::isDistinguishableFrom(QObject *n, QObject *ns) const
{
    return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->isDistinguishableFrom(qmodelingelementproperty_cast<QMofNamedElement *>(n), qmodelingelementproperty_cast<QMofNamespace *>(ns));
}

QString QMofInstanceSpecificationObject::separator() const
{
    return qmodelingelementproperty_cast<QMofInstanceSpecification *>(this)->separator();
}
...
void QMofInstanceSpecificationObject::setGroupProperties()
{
    Q_D(QModelingObject);
    ...
    d->groupProperties.insert(QStringLiteral("QMofInstanceSpecification"), new QMetaProperty(metaObject->property(metaObject->indexOfProperty("classifiers"))));
...
void QMofInstanceSpecificationObject::setPropertyData()
{
