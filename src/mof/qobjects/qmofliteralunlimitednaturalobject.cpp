...
int QMofLiteralUnlimitedNaturalObject::value() const
{
...
int QMofLiteralUnlimitedNaturalObject::unlimitedValue() const
{
...
void QMofLiteralUnlimitedNaturalObject::setValue(int value)
{
