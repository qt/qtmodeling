...
void QMofExpressionObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofExpression, operands, PropertyTypeRole, QStringLiteral("QList<QMofValueSpecification *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofExpression, symbol, PropertyTypeRole, QStringLiteral("QString"));
