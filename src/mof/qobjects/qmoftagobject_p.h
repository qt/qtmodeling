...
**
****************************************************************************/
#ifndef QMOFTAGOBJECT_H
#define QMOFTAGOBJECT_H
...
class Q_MOF_EXPORT QMofTagObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofTagObject)
...
public:
    ...
    Q_INVOKABLE const QSet<QObject *> elements() const;
    Q_INVOKABLE QObject *tagOwner() const;
