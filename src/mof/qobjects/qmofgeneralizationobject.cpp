...
void QMofGeneralizationObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofGeneralization, general, PropertyTypeRole, QStringLiteral("QMofClassifier *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofGeneralization, isSubstitutable, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofGeneralization, specific, PropertyTypeRole, QStringLiteral("QMofClassifier *"));
