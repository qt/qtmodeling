...
**
****************************************************************************/
#ifndef QMOFEXPRESSIONOBJECT_H
#define QMOFEXPRESSIONOBJECT_H
...
class Q_MOF_EXPORT QMofExpressionObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofExpressionObject)
...
public:
    Q_INVOKABLE explicit QMofExpressionObject(QMofExpression *modelingElement);
