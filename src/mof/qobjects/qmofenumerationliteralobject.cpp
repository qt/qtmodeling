...
void QMofEnumerationLiteralObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofEnumerationLiteral, classifier, PropertyTypeRole, QStringLiteral("QMofEnumeration *"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofEnumerationLiteral, enumeration, PropertyTypeRole, QStringLiteral("QMofEnumeration *"));
