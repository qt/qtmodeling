...
**
****************************************************************************/
#ifndef QMOFREFLECTIVECOLLECTIONOBJECT_H
#define QMOFREFLECTIVECOLLECTIONOBJECT_H
...
class Q_MOF_EXPORT QMofReflectiveCollectionObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofReflectiveCollectionObject)
...
#endif // QMOFREFLECTIVECOLLECTIONOBJECT_H
