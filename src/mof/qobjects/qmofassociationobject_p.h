...
**
****************************************************************************/
#ifndef QMOFASSOCIATIONOBJECT_H
#define QMOFASSOCIATIONOBJECT_H
...
class Q_MOF_EXPORT QMofAssociationObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofAssociationObject)
