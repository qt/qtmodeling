...
**
****************************************************************************/
#ifndef QMOFEXCEPTIONOBJECT_H
#define QMOFEXCEPTIONOBJECT_H
...
class Q_MOF_EXPORT QMofExceptionObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofExceptionObject)
...
public:
    ...
    Q_INVOKABLE QObject *objectInError() const;
    Q_INVOKABLE QObject *elementInError() const;
