...
void QMofClassObject::setPropertyData()
{
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofClass, isAbstract, PropertyTypeRole, QStringLiteral("bool"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofClass, nestedClassifiers, PropertyTypeRole, QStringLiteral("QList<QMofClassifier *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofClass, ownedAttributes, PropertyTypeRole, QStringLiteral("QList<QMofProperty *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofClass, ownedOperations, PropertyTypeRole, QStringLiteral("QList<QMofOperation *>"));
    ...
    Q_DECLARE_METAPROPERTY_INFO(QMofClass, superClasses, PropertyTypeRole, QStringLiteral("QSet<QMofClass *>"));
