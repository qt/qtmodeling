...
**
****************************************************************************/
#ifndef QMOFOPAQUEEXPRESSIONOBJECT_H
#define QMOFOPAQUEEXPRESSIONOBJECT_H
...
class Q_MOF_EXPORT QMofOpaqueExpressionObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofOpaqueExpressionObject)
...
public:
    Q_INVOKABLE explicit QMofOpaqueExpressionObject(QMofOpaqueExpression *modelingElement);
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [OpaqueExpression]
...
#endif // QMOFOPAQUEEXPRESSIONOBJECT_H
