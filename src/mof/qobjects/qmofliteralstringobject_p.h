...
**
****************************************************************************/
#ifndef QMOFLITERALSTRINGOBJECT_H
#define QMOFLITERALSTRINGOBJECT_H
...
class Q_MOF_EXPORT QMofLiteralStringObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofLiteralStringObject)
...
#endif // QMOFLITERALSTRINGOBJECT_H
