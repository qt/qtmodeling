...
**
****************************************************************************/
#ifndef QMOFEXTENTOBJECT_H
#define QMOFEXTENTOBJECT_H
...
class Q_MOF_EXPORT QMofExtentObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofExtentObject)
