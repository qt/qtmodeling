...
**
****************************************************************************/
#ifndef QMOFOBJECTOBJECT_H
#define QMOFOBJECTOBJECT_H
...
class Q_MOF_EXPORT QMofObjectObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofObjectObject)
