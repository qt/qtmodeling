...
**
****************************************************************************/
#ifndef QMOFREFLECTIVESEQUENCEOBJECT_H
#define QMOFREFLECTIVESEQUENCEOBJECT_H
...
class Q_MOF_EXPORT QMofReflectiveSequenceObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofReflectiveSequenceObject)
...
#endif // QMOFREFLECTIVESEQUENCEOBJECT_H
