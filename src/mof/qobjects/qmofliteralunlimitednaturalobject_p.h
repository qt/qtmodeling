...
**
****************************************************************************/
#ifndef QMOFLITERALUNLIMITEDNATURALOBJECT_H
#define QMOFLITERALUNLIMITEDNATURALOBJECT_H
...
class Q_MOF_EXPORT QMofLiteralUnlimitedNaturalObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofLiteralUnlimitedNaturalObject)
...
#endif // QMOFLITERALUNLIMITEDNATURALOBJECT_H
