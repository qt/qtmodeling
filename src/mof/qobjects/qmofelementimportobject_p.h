...
**
****************************************************************************/
#ifndef QMOFELEMENTIMPORTOBJECT_H
#define QMOFELEMENTIMPORTOBJECT_H
...
class Q_MOF_EXPORT QMofElementImportObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofElementImportObject)
...
public:
    Q_INVOKABLE explicit QMofElementImportObject(QMofElementImport *modelingElement);
...
#endif // QMOFELEMENTIMPORTOBJECT_H
