...
**
****************************************************************************/
#ifndef QMOFCOMMENTOBJECT_H
#define QMOFCOMMENTOBJECT_H
...
class Q_MOF_EXPORT QMofCommentObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofCommentObject)
...
public:
    Q_INVOKABLE explicit QMofCommentObject(QMofComment *modelingElement);
