...
**
****************************************************************************/
#ifndef QMOFPACKAGEOBJECT_H
#define QMOFPACKAGEOBJECT_H
...
class Q_MOF_EXPORT QMofPackageObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofPackageObject)
