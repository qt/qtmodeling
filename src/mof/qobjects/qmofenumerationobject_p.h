...
**
****************************************************************************/
#ifndef QMOFENUMERATIONOBJECT_H
#define QMOFENUMERATIONOBJECT_H
...
class Q_MOF_EXPORT QMofEnumerationObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofEnumerationObject)
    ...
    Q_PROPERTY(QList<QObject *> ownedLiterals READ ownedLiterals NOTIFY ownedLiteralsChanged)

public:
    Q_INVOKABLE explicit QMofEnumerationObject(QMofEnumeration *modelingElement);
    ...
    Q_INVOKABLE const QList<QObject *> ownedLiterals() const;
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [DataType]
    void ownedAttributesChanged(QList<QObject *> ownedAttributes);
    void ownedOperationsChanged(QList<QObject *> ownedOperations);

    // Signals for owned attributes [Enumeration]
    void ownedLiteralsChanged(QList<QObject *> ownedLiterals);
