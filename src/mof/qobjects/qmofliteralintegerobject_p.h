...
**
****************************************************************************/
#ifndef QMOFLITERALINTEGEROBJECT_H
#define QMOFLITERALINTEGEROBJECT_H
...
class Q_MOF_EXPORT QMofLiteralIntegerObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofLiteralIntegerObject)
...
public:
    Q_INVOKABLE explicit QMofLiteralIntegerObject(QMofLiteralInteger *modelingElement);
...
Q_SIGNALS:
    ...
    // Signals for owned attributes [LiteralInteger]
