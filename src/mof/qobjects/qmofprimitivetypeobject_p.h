...
**
****************************************************************************/
#ifndef QMOFPRIMITIVETYPEOBJECT_H
#define QMOFPRIMITIVETYPEOBJECT_H
...
class Q_MOF_EXPORT QMofPrimitiveTypeObject : public QModelingObject
{
    Q_OBJECT
    Q_DISABLE_COPY(QMofPrimitiveTypeObject)
...
public:
    Q_INVOKABLE explicit QMofPrimitiveTypeObject(QMofPrimitiveType *modelingElement);
...
#endif // QMOFPRIMITIVETYPEOBJECT_H
